...
This document provides detailed guidance on extracting custom hooks from complex components in Terraflow.
...
- Match existing Terraflow patterns: `useFlowsManagerStore`, `useFlowStore`
...
## Common Hook Patterns in Terraflow
...
Terraflow has keyboard shortcut support. Extract shortcut handling to hooks.
