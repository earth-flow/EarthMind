...
This document provides detailed guidance on extracting custom hooks from complex components in EarthMind.
...
- Match existing EarthMind patterns: `useFlowsManagerStore`, `useFlowStore`
...
## Common Hook Patterns in EarthMind
...
EarthMind has keyboard shortcut support. Extract shortcut handling to hooks.
