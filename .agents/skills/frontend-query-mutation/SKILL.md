...
Terraflow uses **Axios + TanStack React Query v5** for data fetching. There is no oRPC or contract layer. The architecture is:
...
3. Preserve Terraflow conventions.
...
Treat this skill as the single query and mutation entry point for Terraflow frontend work. Keep detailed rules in the reference files instead of duplicating them in project docs.
