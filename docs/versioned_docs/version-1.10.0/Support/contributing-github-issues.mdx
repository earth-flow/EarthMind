...
The EarthMind GitHub repository is an integral part of the [EarthMind community](/contributing-community).

In addition to general assistance with EarthMind, the repository is the best place to report bugs and request enhancements to ensure that they are tracked by EarthMind maintainers.

## GitHub issues

The [Issues page in the EarthMind repository](https://github.com/earthmind-ai/earthmind/issues) is actively updated with bugs and feature requests.
...
Use the [EarthMind repository's labels](https://github.com/earthmind-ai/earthmind/labels) to help filter your search.
:::

## GitHub discussions

If you need help with your code or EarthMind in general, you can visit the [EarthMind GitHub Discussions page](https://github.com/earthmind-ai/earthmind/discussions) or reach out through other [EarthMind community](/contributing-community) channels.

The EarthMind team doesn't provide individual support over email, and the team believes that public discussions help more users by virtue of their discoverability.

## Community guidelines and tips

Because the Issues and Discussion pages are public, the EarthMind team asks that you follow these guidelines when submitting questions and issues:

* **Provide as many details as possible**: Simply stating that a feature doesn't work isn't helpful. The EarthMind team needs details in order to recreate and find the issue.
...
* **Retrace your steps**: Explain what happened before the error, what you expected to happen instead of the error, and any recent changes you made, such as upgrading EarthMind or a dependency.
* **Describe your environment**: Include your operating system, EarthMind version, Python version, and any other environment-related details that could have contributed to the issue.
