...
<Cards cols={3}>
  ...
  <Card icon={<Icon name="Cloud" size={20} />} title="Deploy" href="/deployment-overview">
    Deploy EarthMind to production environments.
  </Card>
</Cards>
...
<Cards cols={2}>
  <Card icon={<Icon name="Zap" size={20} />} title="Trigger flows with the API" href="/concepts-publish">
    Use the EarthMind API to run flows from your application code.
  </Card>
  <Card icon={<Icon name="Container" size={20} />} title="Containerize your app" href="/develop-application">
    Build and deploy EarthMind as a containerized application.
  </Card>
</Cards>
...
<Cards cols={2}>
  <Card icon={<Icon name="Bot" size={20} />} title="EarthMind Agents" href="/agents">
    Build and configure AI agents with EarthMind.
  </Card>
  ...
  <Card icon={<Icon name="Plug" size={20} />} title="MCP server" href="/mcp-server">
    Expose EarthMind as an MCP server.
  </Card>
  <Card icon={<Icon name="Cable" size={20} />} title="MCP client" href="/mcp-client">
    Connect EarthMind to external MCP servers.
  </Card>
</Cards>
