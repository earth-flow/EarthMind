---
title: Build components with EarthMind Assistant
slug: /earthmind-assistant
---

import Icon from "@site/src/components/icon";

**EarthMind Assistant** is an in-app virtual assistant pane within the **Playground**.

It can answer questions about the application and help you get more out of EarthMind.

**EarthMind Assistant** understands the structure of the EarthMind graph, so it can create components from natural language prompts.
...
1. In the **Playground**, click the <Icon name="EarthMind" aria-hidden="true"/> **EarthMind** icon.
