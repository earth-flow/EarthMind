...
As of EarthMind 1.9.x, the **MCP Tools** component is not listed as a draggable component under the **Agents** category. To add an MCP tool to a flow, do the following:
