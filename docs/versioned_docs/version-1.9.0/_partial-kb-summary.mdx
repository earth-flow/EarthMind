A EarthMind knowledge base is a local vector database that is stored in EarthMind storage.
...
* **Local storage**: EarthMind knowledge bases are exclusively local.
