...
description: Use CometAPI models in EarthMind to generate text or output a Language Model for downstream Components.
---

import Icon from "@site/src/components/icon";

[Bundles](/components-bundle-components) contain custom components that support specific third-party integrations with EarthMind.
...
3. In EarthMind, add the **CometAPI** component to your flow.
