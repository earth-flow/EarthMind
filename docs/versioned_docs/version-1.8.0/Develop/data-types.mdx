...
The schema is defined in [`data.py`](https://github.com/earthmind-ai/earthmind/blob/main/src/backend/base/earthmind/schema/data.py).
...
The schema is defined in [`dataframe.py`](https://github.com/earthmind-ai/earthmind/blob/main/src/backend/base/earthmind/schema/dataframe.py).

The following attributes are available:

- **Full pandas compatibility**: All pandas DataFrame methods and functionality are supported

- **EarthMind integration**: Accepts lists of [`Data` objects](#data), dictionaries, or existing DataFrames.
...
The `Message` schema is defined in [`message.py`](https://github.com/earthmind-ai/earthmind/blob/main/src/backend/base/earthmind/schema/message.py).
