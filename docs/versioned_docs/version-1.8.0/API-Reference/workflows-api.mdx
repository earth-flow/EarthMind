...
url = f"{EARTHMIND_SERVER_URL}/api/v2/workflows"
headers = {
...
const url = `${EARTHMIND_SERVER_URL}/api/v2/workflows`;
...
url = f"{EARTHMIND_SERVER_URL}/api/v2/workflows/stop"
headers = {
    "Content-Type": "application/json",
    "x-api-key": EARTHMIND_API_KEY
}
...
const url = `${EARTHMIND_SERVER_URL}/api/v2/workflows/stop`;
