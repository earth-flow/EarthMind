...
:::tip
The ALTK contains features called _components_. These are different from EarthMind components. All components within ALTK are available through EarthMind's **ALTK Agent** component.
:::
...
For an example of the ALTK component in EarthMind, see the video tutorial [ALTK in EarthMind: Reliably handle JSON responses in your AI agent](https://www.youtube.com/watch?v=YNwPBK_KxXY).
