...
:::tip
For more examples of the **Loop** component, try the **Research Translation Loop** template in EarthMind, or see the video tutorial [Mastering the Loop Component & Agentic RAG in EarthMind](https://www.youtube.com/watch?v=9Wx7WODSKTo).
:::
