...
You can provide this key directly in your components, or you can use the `COMPOSIO_API_KEY` [global variable](/configuration-global-variables), which EarthMind can automatically load from your `.env` file.
