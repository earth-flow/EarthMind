...
New components are added as objects of the [`Component`](https://github.com/earthmind-ai/earthmind/blob/main/src/lfx/src/lfx/custom/custom_component/component.py) class.

Dependencies are added to the [pyproject.toml](https://github.com/earthmind-ai/earthmind/blob/main/pyproject.toml) file.

## Contribute an example component to EarthMind

Anyone can contribute an example component. For example, to create a new data component called **DataFrame processor**, follow these steps to contribute it to EarthMind.
...
You can view the [/data/__init__.py](https://github.com/earthmind-ai/earthmind/blob/dev/src/lfx/src/lfx/components/data/__init__.py) in the EarthMind repository.

7. Add any new dependencies to the [pyproject.toml](https://github.com/earthmind-ai/earthmind/blob/main/pyproject.toml#L20) file.

8. Submit documentation for your component. For this example component, you would submit documentation to the [Data components page](https://github.com/earthmind-ai/earthmind/blob/main/docs/docs/Components/components-data.mdx).

9. Submit your changes as a pull request. The EarthMind team will review, suggest changes, and add your component to EarthMind.
