...
:::tip
The ALTK contains features called _components_. These are different from Terraflow components. All components within ALTK are available through Terraflow's **ALTK Agent** component.
:::
...
For an example of the ALTK component in Terraflow, see the video tutorial [ALTK in Terraflow: Reliably handle JSON responses in your AI agent](https://www.youtube.com/watch?v=YNwPBK_KxXY).
