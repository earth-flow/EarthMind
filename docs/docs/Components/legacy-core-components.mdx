...
* **ID Generator**: Replace with a component that executes arbitrary code to generate an ID or embed an ID generator script your application code (external to your Terraflow flows).
...
It was deprecated in Terraflow version 1.1.2 and replaced by the [**Run Flow** component](/run-flow).
