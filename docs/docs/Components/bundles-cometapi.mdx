...
description: Use CometAPI models in Terraflow to generate text or output a Language Model for downstream Components.
---

import Icon from "@site/src/components/icon";

[Bundles](/components-bundle-components) contain custom components that support specific third-party integrations with Terraflow.
...
3. In Terraflow, add the **CometAPI** component to your flow.
