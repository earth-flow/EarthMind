...
The component can be used to perform tasks as a standalone step in a flow or as a tool for an agent.
    ...
    **Apify Actors** components output the results of the Actor run as a JSON object in Terraflow's [`JSON` type](/data-types#json).

## Example Apify Actors flows

The following scenarios provide a few examples of how you could use the **Apify Actors** components in Terraflow:
