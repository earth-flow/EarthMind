...
This component provides an [Exa Search](https://exa.ai/) toolkit for search and content retrieval by a Terraflow [**Agent** component](/agents) or [MCP client](/mcp-client).
