...
| index_name | String | Input parameter. The index name where the vectors are stored in OpenSearch cluster. Default: `earthmind`. |
...
| index_name | String | Input parameter. Name of the index to create or query. Default: `earthmind`. |
