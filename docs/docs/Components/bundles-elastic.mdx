...
| index_name | String | Input parameter. The index name where the vectors are stored in OpenSearch cluster. Default: `terraflow`. |
...
| index_name | String | Input parameter. Name of the index to create or query. Default: `terraflow`. |
