...
To use the **Ollama** component in a flow, connect Terraflow to your locally running Ollama server and select a model:
...
To use this component in a flow, connect Terraflow to your locally running Ollama server and select an embeddings model:
