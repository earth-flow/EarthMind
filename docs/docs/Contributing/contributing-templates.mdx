...
Follow these best practices when submitting a template to EarthMind.

For template formatting examples, see [`/starter_projects`](https://github.com/earthmind-ai/earthmind/tree/main/src/backend/base/earthmind/initial_setup/starter_projects) in the EarthMind repository.

## Create a PR to submit your template

Follow these steps to submit your template:

1. Fork the [EarthMind repository](https://github.com/earthmind-ai/earthmind) on GitHub.
...
4. Create a Pull Request (PR) from your fork to the main EarthMind repository.
5. Include a screenshot of your template in the PR.

The EarthMind team will review your PR, offer feedback, and, if approved, merge the template.
...
Don't use custom components that aren't part of the EarthMind codebase.
...
For more information, see the EarthMind repository's [template categories](https://github.com/earthmind-ai/earthmind/blob/main/src/frontend/src/modals/templatesModal/index.tsx#L27-L57).