...
Follow these best practices when submitting a template to Terraflow.

For template formatting examples, see [`/starter_projects`](https://github.com/terraflow-ai/terraflow/tree/main/src/backend/base/terraflow/initial_setup/starter_projects) in the Terraflow repository.

## Create a PR to submit your template

Follow these steps to submit your template:

1. Fork the [Terraflow repository](https://github.com/terraflow-ai/terraflow) on GitHub.
...
4. Create a Pull Request (PR) from your fork to the main Terraflow repository.
5. Include a screenshot of your template in the PR.

The Terraflow team will review your PR, offer feedback, and, if approved, merge the template.
...
Don't use custom components that aren't part of the Terraflow codebase.
...
For more information, see the Terraflow repository's [template categories](https://github.com/terraflow-ai/terraflow/blob/main/src/frontend/src/modals/templatesModal/index.tsx#L27-L57).