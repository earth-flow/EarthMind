...
By default, [Terraflow agents](/agents) only include the functionality built-in to their base LLM.
...
2. Enter Python code into the **Code** pane to create the custom component.
    ...
    class TextAnalyzerComponent(Component):
        ...
        documentation: str = "http://docs.terraflow.org/components/custom"
        icon = "chart-bar"
...
Terraflow supports **Tool Mode** for the following data types:
