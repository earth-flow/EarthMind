...
As of Terraflow 1.9.x, the **MCP Tools** component is not listed as a draggable component under the **Agents** category. To add an MCP tool to a flow, do the following:
...
2. Configure and save the server.
   ...
   For more information, see [Use Terraflow as an MCP client](/mcp-client).
