...
Use the `/projects` endpoint to create, read, update, and delete [Terraflow projects](/concepts-flows#projects).

## Read projects

Get a list of Terraflow projects, including project IDs, names, and descriptions.
...
Import a project and its flows by uploading a Terraflow project zip file:
