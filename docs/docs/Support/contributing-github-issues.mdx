...
The Terraflow GitHub repository is an integral part of the [Terraflow community](/contributing-community).

In addition to general assistance with Terraflow, the repository is the best place to report bugs and request enhancements to ensure that they are tracked by Terraflow maintainers.

## GitHub issues

The [Issues page in the Terraflow repository](https://github.com/terraflow-ai/terraflow/issues) is actively updated with bugs and feature requests.
...
Use the [Terraflow repository's labels](https://github.com/terraflow-ai/terraflow/labels) to help filter your search.
:::

## GitHub discussions

If you need help with your code or Terraflow in general, you can visit the [Terraflow GitHub Discussions page](https://github.com/terraflow-ai/terraflow/discussions) or reach out through other [Terraflow community](/contributing-community) channels.

The Terraflow team doesn't provide individual support over email, and the team believes that public discussions help more users by virtue of their discoverability.

## Community guidelines and tips

Because the Issues and Discussion pages are public, the Terraflow team asks that you follow these guidelines when submitting questions and issues:

* **Provide as many details as possible**: Simply stating that a feature doesn't work isn't helpful. The Terraflow team needs details in order to recreate and find the issue.
...
* **Retrace your steps**: Explain what happened before the error, what you expected to happen instead of the error, and any recent changes you made, such as upgrading Terraflow or a dependency.
* **Describe your environment**: Include your operating system, Terraflow version, Python version, and any other environment-related details that could have contributed to the issue.
