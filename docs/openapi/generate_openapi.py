#!/usr/bin/env python3
"""Generate the Terraflow OpenAPI specification.

This script imports the Terraflow FastAPI application and writes its OpenAPI
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate Terraflow OpenAPI specification.")
    parser.add_argument(
        "--output",
        "-o",
        type=Path,
