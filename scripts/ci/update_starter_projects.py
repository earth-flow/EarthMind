"""Script to update Terraflow starter projects with the latest component versions."""

import asyncio
import os

import terraflow.main  # noqa: F401
...
async def main():
    ...
    Copies the code from terraflow/initial_setup/setup.py. Doesn't use the
    ...
    for project_path, project in starter_projects:
        ...
        do_update_starter_projects = os.environ.get("TERRAFLOW_UPDATE_STARTER_PROJECTS", "true").lower() == "true"
