"""Script to update EarthMind starter projects with the latest component versions."""

import asyncio
import os

import earthmind.main  # noqa: F401
...
async def main():
    ...
    Copies the code from earthmind/initial_setup/setup.py. Doesn't use the
    ...
    for project_path, project in starter_projects:
        ...
        do_update_starter_projects = os.environ.get("EARTHMIND_UPDATE_STARTER_PROJECTS", "true").lower() == "true"
