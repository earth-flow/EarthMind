...
Write-Host "Starting Terraflow frontend build process..." -ForegroundColor Green
...
Write-Host "You can now run the backend with: uv run terraflow run" -ForegroundColor Cyan
Read-Host "Press Enter to exit"