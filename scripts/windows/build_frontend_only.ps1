...
Write-Host "Starting EarthMind frontend build process..." -ForegroundColor Green
...
Write-Host "You can now run the backend with: uv run earthmind run" -ForegroundColor Cyan
Read-Host "Press Enter to exit"