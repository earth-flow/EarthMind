...
STARTER_PROJECTS_DIR = REPO_ROOT / "src/backend/base/earthmind/initial_setup/starter_projects"

# NOTE: _safe_flow_key and _note_hash are intentionally kept inline (not imported from
# earthmind.utils.i18n_keys) because this script is designed to run WITHOUT a virtualenv —
