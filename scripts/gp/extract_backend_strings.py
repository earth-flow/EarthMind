"""Extract translatable strings from Terraflow component classes.
...
OUTPUT_PATH = Path(__file__).parent.parent.parent / "src/backend/base/terraflow/locales/en.json"
STARTER_PROJECTS_DIR = Path(__file__).parent.parent.parent / "src/backend/base/terraflow/initial_setup/starter_projects"


def collect_strings() -> dict[str, str]:
    """Walk lfx.components and extract all translatable display_name strings."""
    from terraflow.utils.i18n_keys import component_field_key as _component_field_key
    from terraflow.utils.i18n_keys import normalize_component_key as _normalize_component_key
    from terraflow.utils.i18n_keys import safe_flow_key as _safe_key
