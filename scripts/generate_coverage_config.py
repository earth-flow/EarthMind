...
[run]
source = src/backend/base/earthmind
omit =
    # Test files
    */tests/*
    */test_*
...
def main():
    ...
    backend_components_path = project_root / "src" / "backend" / "base" / "earthmind" / "components"
    ...
    print("cd src/backend && python -m pytest --cov=src/backend/base/earthmind --cov-config=.coveragerc")
