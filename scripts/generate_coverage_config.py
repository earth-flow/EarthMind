...
[run]
source = src/backend/base/terraflow
omit =
    # Test files
    */tests/*
    */test_*
...
def main():
    ...
    backend_components_path = project_root / "src" / "backend" / "base" / "terraflow" / "components"
    ...
    print("cd src/backend && python -m pytest --cov=src/backend/base/terraflow --cov-config=.coveragerc")
