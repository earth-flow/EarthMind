"""Pydantic models mirroring the EarthMind REST API request/response shapes."""
...
class Flow(BaseModel):
    """A flow returned by the EarthMind API."""
...
class Project(BaseModel):
    """A project (folder) returned by the EarthMind API."""
...
class RunOutput(BaseModel):
    ...
    def first_text(self) -> str | None:
        ...
        for component_out in self.outputs:
            ...
            # Standard EarthMind chat output: results -> message -> text
    ...
    def has_errors(self) -> bool:
        ...
        Adapted from ``WorkflowResponse.has_errors()`` in earthmind-ai/sdk
...
class RunResponse(BaseModel):
    ...
    # (adapted from earthmind-ai/sdk, Janardan Singh Kavia, IBM Corp.,
    #  Apache 2.0 — https://github.com/earthmind-ai/sdk/pull/1)
    # ------------------------------------------------------------------
    ...
    def get_chat_output(self) -> str | None:
        ...
        convention from the EarthMind V2 SDK::
    ...
    def is_completed(self) -> bool:
        ...
        ``WorkflowResponse.is_completed()`` in earthmind-ai/sdk
        (Janardan Singh Kavia, IBM Corp., Apache 2.0).
        """
    ...
    def is_failed(self) -> bool:
        ...
        Adapted from ``WorkflowResponse.is_failed()`` in earthmind-ai/sdk
        (Janardan Singh Kavia, IBM Corp., Apache 2.0).
        """
    ...
    def is_in_progress(self) -> bool:
        ...
        Included for API parity with :class:`BackgroundJob` and the EarthMind
...
class StreamChunk(BaseModel):
    ...
    Events emitted by the EarthMind backend:
