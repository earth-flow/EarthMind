"""Pydantic models mirroring the Terraflow REST API request/response shapes."""
...
class Flow(BaseModel):
    """A flow returned by the Terraflow API."""
...
class Project(BaseModel):
    """A project (folder) returned by the Terraflow API."""
...
class RunOutput(BaseModel):
    ...
    def first_text(self) -> str | None:
        ...
        for component_out in self.outputs:
            ...
            # Standard Terraflow chat output: results -> message -> text
    ...
    def has_errors(self) -> bool:
        ...
        Adapted from ``WorkflowResponse.has_errors()`` in terraflow-ai/sdk
...
class RunResponse(BaseModel):
    ...
    # (adapted from terraflow-ai/sdk, Janardan Singh Kavia, IBM Corp.,
    #  Apache 2.0 — https://github.com/terraflow-ai/sdk/pull/1)
    # ------------------------------------------------------------------
    ...
    def get_chat_output(self) -> str | None:
        ...
        convention from the Terraflow V2 SDK::
    ...
    def is_completed(self) -> bool:
        ...
        ``WorkflowResponse.is_completed()`` in terraflow-ai/sdk
        (Janardan Singh Kavia, IBM Corp., Apache 2.0).
        """
    ...
    def is_failed(self) -> bool:
        ...
        Adapted from ``WorkflowResponse.is_failed()`` in terraflow-ai/sdk
        (Janardan Singh Kavia, IBM Corp., Apache 2.0).
        """
    ...
    def is_in_progress(self) -> bool:
        ...
        Included for API parity with :class:`BackgroundJob` and the Terraflow
...
class StreamChunk(BaseModel):
    ...
    Events emitted by the Terraflow backend:
