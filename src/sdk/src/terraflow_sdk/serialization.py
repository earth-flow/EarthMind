"""Git-friendly flow serialization for terraflow-sdk.

``normalize_flow`` transforms a raw Terraflow flow dict into a stable,
...
def normalize_flow(
    ...
    *,
    ...
    ----------
    flow:
        Raw flow dict as returned by the Terraflow API or read from a ``.json``
        file.
    strip_volatile:
