...
class TestDependencyAnalyzer:
    ...
    def test_top_level_basic(self):
        ...
        from lfx.custom.dependency_analyzer import _top_level
    ...
    def test_is_relative(self):
        ...
        from lfx.custom.dependency_analyzer import _is_relative
...
"""
    ...
    def test_dependency_info_dataclass(self):
        ...
        from lfx.custom.dependency_analyzer import DependencyInfo
