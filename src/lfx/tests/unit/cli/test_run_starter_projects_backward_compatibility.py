...
class TestRunStarterProjectsBackwardCompatibility:
    ...
    def test_run_1_6_0_starter_project_no_import_errors(self, template_file):
        """Test that 1.6.0 starter project can be loaded without terraflow or lfx import errors.
        ...
        known_failing_projects = {
            "News Aggregator.json": "Contains SaveToFile component with terraflow.api import bug "
            ...
            if "No module named 'terraflow'" in all_output or "Module terraflow" in all_output:
                ...
                for line in all_output.split("\n"):
                    if "terraflow" in line and ("No module named" in line or "Module" in line):
                        ...
                        break
                pytest.fail(f"Terraflow import error found in 1.6.0 template {template_file.name}.\nError: {error_line}")
    ...
    @pytest.mark.xfail(
        reason="1.6.0 basic templates have terraflow import issues - components expect terraflow package to be available"
    )
    def test_run_basic_1_6_0_starter_projects_detailed(self):
        ...
        for template_name in basic_templates:
            ...
            if "No module named 'terraflow'" in all_output:
                pytest.fail(f"Terraflow import error in 1.6.0 template {template_name}")
            ...
            if "ModuleNotFoundError" in all_output and "terraflow" in all_output and "lfx.services" not in all_output:
                ...
                pytest.fail(f"Module not found error for terraflow in 1.6.0 template {template_name}")
    ...
    def test_run_1_6_0_starter_project_with_stdin(self, template_file):
        ...
        all_output = result.output
        if "No module named 'terraflow'" in all_output:
            pytest.fail("Terraflow import error in 1.6.0 stdin test")
    ...
    def test_run_1_6_0_starter_project_inline_json(self, template_file):
        ...
        all_output = result.output
        if "No module named 'terraflow'" in all_output:
            pytest.fail("Terraflow import error in 1.6.0 inline JSON test")
