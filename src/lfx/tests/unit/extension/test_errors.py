...
_FIRST_LINE_EXPECTATIONS: dict[str, str] = {
    "manifest-not-found": "error[manifest-not-found]: No extension.json or [tool.terraflow.extension] entry found in loc.",  # noqa: E501
    ...
    "duplicate-inline-bundle": "error[duplicate-inline-bundle]: Inline bundle name 'content' appears in multiple TERRAFLOW_COMPONENTS_PATH entries; first wins. Locations: loc.",  # noqa: E501
    ...
    "inline-path-missing": "error[inline-path-missing]: TERRAFLOW_COMPONENTS_PATH entry 'content' does not exist or is not a directory; skipped.",  # noqa: E501
    "inline-path-unreadable": "error[inline-path-unreadable]: TERRAFLOW_COMPONENTS_PATH entry 'content' could not be enumerated: msg",  # noqa: E501
    ...
    "extension-reload-disabled": "error[extension-reload-disabled]: Extension reload is disabled on this server.  Set TERRAFLOW_ENABLE_EXTENSION_RELOAD=true to enable it on a local-development install (Mode A).",  # noqa: E501
