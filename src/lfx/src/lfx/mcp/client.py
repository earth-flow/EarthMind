"""Async HTTP client for Terraflow REST API.
...
class TerraflowClient:
    """Async HTTP client for Terraflow's REST API.
    ...
    def __init__(
        ...
        self.server_url = (server_url or os.environ.get("TERRAFLOW_SERVER_URL", "http://10.171.205.153:7860")).rstrip("/")
        self.api_key = api_key or os.environ.get("TERRAFLOW_API_KEY")
