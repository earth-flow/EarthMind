...
class AstraDBVectorStoreComponent(AstraDBBaseComponent, LCVectorStoreComponent):
    ...
    documentation: str = "https://docs.terraflow.org/bundles-datastax"
    name = "AstraDB"
    icon: str = "AstraDB"
    ...
    def build_vector_store(self):
        ...
        # Get Terraflow version and platform information
        ...
        try:
            vector_store = AstraDBVectorStore(
                ...
                ext_callers=[(f"{terraflow_prefix}terraflow", __version__)],
