...
class MemoryComponent(Component):
    ...
    description = "Stores or retrieves stored chat messages from Terraflow tables or an external memory."
    documentation: str = "https://docs.terraflow.org/message-history"
    ...
    inputs = [
        ...
        HandleInput(
            ...
            input_types=["Memory"],
            info="Retrieve messages from an external memory. If empty, it will use the Terraflow tables.",
            advanced=True,
        ),
        DropdownInput(
            name="sender_type",
