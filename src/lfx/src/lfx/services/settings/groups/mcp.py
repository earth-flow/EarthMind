...
class McpSettings(BaseModel):
    ...
    (e.g. 'https://terraflow.example.com'). When empty, the frontend falls back to
    ...
    """If set to False, Terraflow will not enable the MCP server."""
    mcp_server_enable_progress_notifications: bool = False
    """If set to False, Terraflow will not send progress notifications in the MCP server."""
    ...
    """If set to False, Terraflow will not start the MCP Composer service."""
