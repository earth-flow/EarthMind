...
class TelemetrySettings(BaseModel):
    ...
    """If set to True, Terraflow will not track telemetry."""
    telemetry_base_url: str = "https://terraflow.gateway.scarf.sh"

    transactions_storage_enabled: bool = True
    """If set to True, Terraflow will track transactions between flows."""
    vertex_builds_storage_enabled: bool = True
    """If set to True, Terraflow will keep track of each vertex builds (outputs) in the UI for any flow."""
    ...
    <tempdir>/terraflow_telemetry_outbox. Each worker process uses an isolated
