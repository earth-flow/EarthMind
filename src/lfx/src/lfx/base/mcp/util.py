...
def _unwrap_terraflow_json_value(value: Any) -> Any:
    """Return the payload dict from Terraflow JSON/Data values wired into MCP object parameters."""
...
def _try_convert_value(value: Any, expected_type: type, field_name: str, tool_name: str) -> Any:
    ...
    if expected_type in (dict, list):
        value = _unwrap_terraflow_json_value(value)
...
async def get_flow_snake_case(flow_name: str, user_id: str, session, *, is_action: bool | None = None):
    try:
        ...
        msg = "Terraflow Flow model is not available. This feature requires the full Terraflow installation."
...
# TODO(terraflow-ai/terraflow#12541-followup): MCPSessionManager lives in this
