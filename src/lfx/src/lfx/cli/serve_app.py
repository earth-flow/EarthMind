...
# Security - use the same pattern as Terraflow main API
...
class UploadFlowRequest(BaseModel):
    ...
    id: str | None = Field(default=None, description="Stable flow ID from Terraflow export (must be a valid UUID)")
