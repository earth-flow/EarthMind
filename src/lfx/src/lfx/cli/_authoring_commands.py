...
def register(app: typer.Typer) -> None:
    ...
    def create_command_wrapper(
        ...
        *,
        ...
        """Scaffold a new Terraflow flow JSON from a built-in template (lazy-loaded)."""
    ...
    def requirements_command_wrapper(
        flow_path: str = typer.Argument(help="Path to the Terraflow flow JSON file"),
        ...
        *,
        ...
        """Generate requirements.txt from a Terraflow flow JSON (lazy-loaded)."""
        import json
        from pathlib import Path
    ...
    def validate_command_wrapper(
        flow_paths: list[str] = typer.Argument(
            default=None,
            help="Path(s) to Terraflow flow JSON file(s) or directories to validate. Defaults to flows/.",
        ),
        ...
        """Validate Terraflow flow JSON files without executing them (lazy-loaded)."""
