...
describe("file-utils", () => {
  ...
  describe("getFilePreviewUrl", () => {
    ...
    describe("Windows path normalization and URL construction", () => {
      ...
      it("should_not_treat_terraflow_substrings_as_special_path_segments", () => {
        const windowsPath = "C:\\temp\\terraflow-report\\flow123\\image.png";
        const expected =
          "http://localhost:3000/api/v1/files/images/C%3A/temp/terraflow-report/flow123/image.png";
