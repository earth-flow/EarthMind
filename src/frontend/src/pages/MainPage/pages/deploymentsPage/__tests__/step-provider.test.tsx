...
describe("Basic rendering", () => {
  ...
  it("renders signup and credentials help links", () => {
    ...
    expect(
      ...
      "href",
      "https://www.ibm.com/products/watsonx-orchestrate?utm_source=earthmind&utm_medium=integration&utm_campaign=wxo-integration&utm_content=signup-pricing#pricing",
    );
    expect(
      screen.getByRole("link", { name: "Find your credentials" }),
    ).toHaveAttribute(
      "href",
      "https://www.ibm.com/docs/en/watsonx/watson-orchestrate/base?topic=api-getting-started&utm_source=earthmind&utm_medium=integration&utm_campaign=wxo-integration&utm_content=docs-credentials",
    );
  });
});
