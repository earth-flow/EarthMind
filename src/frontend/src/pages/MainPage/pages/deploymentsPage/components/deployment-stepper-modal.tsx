...
export default function DeploymentStepperModal({
  ...
  // the /flows endpoint, NOT from the EarthMind database. This means:
  //
  // - If a user renames a tool in the wxO console, the new name appears
  //   here on the next edit. EarthMind doesn't cache tool names locally.
  // - If a tool is deleted in wxO, provider_data will be null and the
  //   review page falls back to the EarthMind flow name.
