  ...
  return JSON.stringify(
    {
      mcpServers: {
        terraflow: {
          ...
          env: {
            TERRAFLOW_SERVER_URL: serverUrl,
            TERRAFLOW_API_KEY: "YOUR_API_KEY", // pragma: allowlist secret
          },
        },
      },
    },
...
function getClaudeCodeCommand(serverUrl: string): string {
  return `claude mcp add terraflow -- uvx --from lfx lfx-mcp \\
  -e TERRAFLOW_SERVER_URL=${serverUrl} \\
  -e TERRAFLOW_API_KEY=YOUR_API_KEY`;
}
