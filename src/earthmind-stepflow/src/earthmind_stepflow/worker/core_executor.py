"""Core component executor for known EarthMind components.

Executes known EarthMind components by importing them directly by module path,
...
class CoreExecutor(BaseExecutor):
    """Executes known EarthMind components by importing them directly.
    ...
    async def execute(
        ...
        """Execute a core EarthMind component.

        Args:
            component_path: The component path suffix after /earthmind/core/
