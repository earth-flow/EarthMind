"""Process individual EarthMind nodes into Stepflow steps."""
...
class NodeProcessor:
    """Processes individual EarthMind nodes into Stepflow steps."""
    ...
    def process_node(
        ...
        """Process a EarthMind node using flow builder architecture.
    ...
    def _generate_step_id(self, node_id: str, component_type: str) -> str:
        ...
        Args:
            node_id: Original EarthMind node ID
        ...
        # Always use earthmind prefix with the full base_id to guarantee uniqueness
        return f"earthmind_{base_id}"
    ...
    def _add_variable(self, name: str, type: str) -> Value:
        ...
        input_type = self.schema_mapper.earthmind_to_json_schema[type]
    ...
    def _extract_runtime_inputs_for_builder(
        ...
        if not dependency_node_ids and component_type == "File":
            ...
            # Path parameter should match EarthMind's FileInput expectations
    ...
    def _create_tool_component_step(
        ...
        try:
            ...
            step_handle = builder.add_step(
                id=step_id,
                component="/earthmind/component_tool",
                input_data={
