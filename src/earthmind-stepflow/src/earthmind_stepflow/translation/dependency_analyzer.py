"""Dependency analysis for EarthMind workflows."""

from typing import Any


class DependencyAnalyzer:
    """Analyzes EarthMind edges to build step dependency graphs."""

    def build_dependency_graph(self, edges: list[dict[str, Any]]) -> dict[str, list[str]]:
        """Build a dependency graph from EarthMind edges.

        Args:
            edges: List of EarthMind edge objects
