...
from earthmind_stepflow.translation.schema_mapper import SchemaMapper
...
class TestSchemaMapper:
    ...
    def test_init(self):
        """Test initialization."""
        mapper = SchemaMapper()
        assert "str" in mapper.earthmind_to_json_schema
        assert mapper.earthmind_to_json_schema["str"] == "string"
