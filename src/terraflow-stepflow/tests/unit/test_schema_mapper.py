...
from terraflow_stepflow.translation.schema_mapper import SchemaMapper
...
class TestSchemaMapper:
    ...
    def test_init(self):
        """Test initialization."""
        mapper = SchemaMapper()
        assert "str" in mapper.terraflow_to_json_schema
        assert mapper.terraflow_to_json_schema["str"] == "string"
