...
Terraflow component testing. It handles environment variables, pytest
...
class TweaksBuilder:
    ...
    def add_tweak(self, component_id: str, field_name: str, value: Any) -> "TweaksBuilder":
        ...
        Args:
            component_id: Terraflow component ID (e.g., "LanguageModelComponent-abc123")
    ...
    def add_astradb_tweaks(
        ...
        **kwargs: Any,
        ...
        Args:
            component_id: Terraflow component ID
        ...
        if "database_name" not in kwargs:
            kwargs["database_name"] = "terraflow-test"
...
def create_openai_test_tweaks(*component_ids: str) -> dict[str, dict[str, Any]]:
    ...
    Args:
        *component_ids: Terraflow component IDs that use OpenAI API key
...
def create_astradb_test_tweaks(*component_ids: str, **overrides: Any) -> dict[str, dict[str, Any]]:
    ...
    Args:
        *component_ids: Terraflow component IDs that use AstraDB
