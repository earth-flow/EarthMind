"""Core component executor for known Terraflow components.

Executes known Terraflow components by importing them directly by module path,
...
class CoreExecutor(BaseExecutor):
    """Executes known Terraflow components by importing them directly.
    ...
    async def execute(
        ...
        """Execute a core Terraflow component.

        Args:
            component_path: The component path suffix after /terraflow/core/
