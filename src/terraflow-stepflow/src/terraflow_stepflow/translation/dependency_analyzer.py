"""Dependency analysis for Terraflow workflows."""

from typing import Any


class DependencyAnalyzer:
    """Analyzes Terraflow edges to build step dependency graphs."""

    def build_dependency_graph(self, edges: list[dict[str, Any]]) -> dict[str, list[str]]:
        """Build a dependency graph from Terraflow edges.

        Args:
            edges: List of Terraflow edge objects
