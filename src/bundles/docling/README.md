...
Docling components for Terraflow packaged as a standalone Extension Bundle.
...
The bundle is installed with Terraflow in the 1.10 workspace. The base package includes `docling-core` for the `DoclingDocument` schema. For standalone local conversion:
