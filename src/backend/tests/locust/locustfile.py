...
class FlowRunUser(FastHttpUser):
    """FlowRunUser simulates users sending requests to the Terraflow run endpoint.
    ...
    def run_flow_endpoint(self):
        ...
        payload = {
            "input_value": (
                "Hey, Could you check https://docs.terraflow.org for me? Later, could you calculate 1390 / 192 ?"
            ),
            "output_type": "chat",
            "input_type": "chat",
            "tweaks": {},
