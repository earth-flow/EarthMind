...
def disable_ssrf(monkeypatch):
    ...
    monkeypatch.setenv("TERRAFLOW_SSRF_PROTECTION_ENABLED", "false")
...
class TestURLComponentSSRFProtection:
    ...
    def enable_ssrf(self, monkeypatch):
        ...
        monkeypatch.setenv("TERRAFLOW_SSRF_PROTECTION_ENABLED", "true")
        monkeypatch.delenv("TERRAFLOW_SSRF_ALLOWED_HOSTS", raising=False)
