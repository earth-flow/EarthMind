...
class TestDatabaseServiceWindowsPostgres:
    ...
    @patch("earthmind.services.database.service.create_async_engine")
    @patch("earthmind.services.database.service.configure_windows_postgres_event_loop")
    ...
    def test_database_url_sanitization(self, mock_settings_service):
        ...
        with patch("earthmind.services.database.service.create_async_engine") as mock_create_engine:
            mock_create_engine.return_value = MagicMock()
    ...
    def test_docker_environment_compatibility(self, mock_platform, mock_settings_service):
        ...
        mock_settings_service.settings.database_url = "postgresql://postgres:5432/earthmind"
        ...
        with patch("earthmind.services.database.service.create_async_engine") as mock_create_engine:
            ...
            service = DatabaseService(mock_settings_service)
            assert service.database_url == "postgresql+psycopg://postgres:5432/earthmind"
