"""Unit tests for earthmind.core.celery_app module."""
...
class TestMakeCelery:
    ...
    def test_make_celery_creates_celery_instance(self):
        ...
        from earthmind.core.celery_app import make_celery
        ...
        with patch.dict("sys.modules", {"earthmind.core.celeryconfig": mock_config}):
            # Act - Create a real Celery instance
            celery_app = make_celery("test_app", "earthmind.core.celeryconfig")
    ...
    def test_make_celery_sets_task_routes(self):
        ...
        with patch.dict("sys.modules", {"earthmind.core.celeryconfig": mock_config}):
            app1 = make_celery("app1", "earthmind.core.celeryconfig")
            app2 = make_celery("app2", "earthmind.core.celeryconfig")
    ...
    def test_make_celery_with_different_configs(self):
        ...
        with patch.dict("sys.modules", {"earthmind.core.celeryconfig": mock_config1}):
            app1 = make_celery("test_app", "earthmind.core.celeryconfig")
            assert app1.conf.broker_url == "redis://test1:6379/0"

        with patch.dict("sys.modules", {"earthmind.core.celeryconfig": mock_config2}):
            app2 = make_celery("test_app", "earthmind.core.celeryconfig")
    ...
    def test_make_celery_error_handling(self):
        ...
        with patch("earthmind.core.celery_app.Celery") as mock_celery_class:
    ...
    def test_make_celery_configuration_application(self):
        ...
        from earthmind.core.celery_app import celery_app
        ...
        assert celery_app.main == "earthmind"
