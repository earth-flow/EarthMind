...
(authenticated, documented in ``docs/features/terraflow-assistant.md``,
...
from terraflow.agentic.api.files_router import router as files_router
from terraflow.agentic.api.router import router as assistant_router
