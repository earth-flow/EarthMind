...
class TestIntentRoutingRealLLM:
    ...
    async def test_pt_canvas_question_is_not_false_off_topic(self):
        ...
        assert result.intent != "off_topic", f"Terraflow-related request misrouted to off_topic ({result.intent})"
...
class TestRuntimeValidationReal:
    ...
    async def test_rejects_output_returning_non_dict_from_input(self):
        ...
        from terraflow.agentic.helpers.validation import validate_component_runtime
...
class TestUserComponentOverlayReal:
    ...
    def test_registered_component_is_discoverable_by_class_name(self, tmp_path, monkeypatch):
        ...
        from terraflow.agentic.services.user_components import register_user_component
        from terraflow.agentic.services.user_components_overlay import (
