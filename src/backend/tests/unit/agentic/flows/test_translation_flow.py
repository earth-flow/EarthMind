...
from terraflow.agentic.flows.translation_flow import (
    TRANSLATION_PROMPT,
    _build_model_config,
    get_graph,
)
...
class TestGetGraph:
    ...
    def test_should_create_graph_with_default_provider(self):
        ...
        with (
            patch("terraflow.agentic.flows.translation_flow.ChatInput"),
            patch("terraflow.agentic.flows.translation_flow.ChatOutput"),
            patch("terraflow.agentic.flows.translation_flow.LanguageModelComponent") as mock_llm,
            patch("terraflow.agentic.flows.translation_flow.Graph"),
        ):
    ...
    def test_should_configure_chat_input(self):
        ...
        with (
            patch("terraflow.agentic.flows.translation_flow.ChatInput") as mock_chat_input,
            patch("terraflow.agentic.flows.translation_flow.ChatOutput"),
            patch("terraflow.agentic.flows.translation_flow.LanguageModelComponent"),
            patch("terraflow.agentic.flows.translation_flow.Graph"),
        ):
    ...
    def test_should_configure_chat_output(self):
        ...
        with (
            patch("terraflow.agentic.flows.translation_flow.ChatInput"),
            patch("terraflow.agentic.flows.translation_flow.ChatOutput") as mock_chat_output,
            patch("terraflow.agentic.flows.translation_flow.LanguageModelComponent"),
            patch("terraflow.agentic.flows.translation_flow.Graph"),
        ):
    ...
    def test_should_create_graph_with_start_and_end(self):
        ...
        with (
            ...
            patch("terraflow.agentic.flows.translation_flow.ChatOutput") as mock_chat_output,
            patch("terraflow.agentic.flows.translation_flow.LanguageModelComponent"),
            patch("terraflow.agentic.flows.translation_flow.Graph") as mock_graph_class,
        ):
