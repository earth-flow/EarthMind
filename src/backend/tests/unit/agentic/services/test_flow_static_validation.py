...
Thin wrapper that reuses Terraflow's existing CLI validator
...
from terraflow.agentic.services.flow_static_validation import (
    FlowValidationReport,
    validate_flow_spec,
)

MODULE = "terraflow.agentic.services.flow_static_validation"
