...
def isolated_sandbox(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> Path:
    ...
    from terraflow.agentic.services.user_components_context import reset_current_user_id
    from terraflow.agentic.services.user_components_overlay import _OVERLAY_ENTRY_CACHE
