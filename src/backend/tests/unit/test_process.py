...
from terraflow.services.deps import get_session_service
from terraflow.services.utils import register_all_service_factories
...
def test_apply_tweaks_code_override_prevention():
    ...
    from terraflow.processing.process import apply_tweaks
    ...
    # Capture log output
    with patch("terraflow.processing.process.logger") as mock_logger:
