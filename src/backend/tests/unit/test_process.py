...
from earthmind.services.deps import get_session_service
from earthmind.services.utils import register_all_service_factories
...
def test_apply_tweaks_code_override_prevention():
    ...
    from earthmind.processing.process import apply_tweaks
    ...
    # Capture log output
    with patch("earthmind.processing.process.logger") as mock_logger:
