...
from terraflow.services.database.models.flow import FlowUpdate
...
async def test_build_flow_validates_request_data_instead_of_stale_db_flow(
    ...
    monkeypatch.setattr(
        "terraflow.api.v1.chat.validate_flow_for_current_settings",
...
async def test_cancel_build_unexpected_error(client, json_memory_chatbot_no_llm, logged_in_headers, monkeypatch):
    ...
    import terraflow.api.v1.chat

    original_cancel_flow_build = terraflow.api.v1.chat.cancel_flow_build

    async def mock_cancel_flow_build_with_error(*_args, **_kwargs):
        msg = "Unexpected error during cancellation"
        raise RuntimeError(msg)

    monkeypatch.setattr(terraflow.api.v1.chat, "cancel_flow_build", mock_cancel_flow_build_with_error)
    ...
    try:
        ...
        monkeypatch.setattr(terraflow.api.v1.chat, "cancel_flow_build", original_cancel_flow_build)
...
async def test_cancel_build_success(client, json_memory_chatbot_no_llm, logged_in_headers, monkeypatch):
    ...
    monkeypatch.setattr(terraflow.api.v1.chat, "cancel_flow_build", mock_successful_cancel_flow_build)
...
async def test_cancel_build_failure(client, json_memory_chatbot_no_llm, logged_in_headers, monkeypatch):
    ...
    monkeypatch.setattr(terraflow.api.v1.chat, "cancel_flow_build", mock_cancel_flow_build)
...
async def test_cancel_build_with_cancelled_error(client, json_memory_chatbot_no_llm, logged_in_headers, monkeypatch):
    ...
    monkeypatch.setattr(terraflow.api.v1.chat, "cancel_flow_build", mock_cancel_flow_build_with_cancelled_error)
...
async def test_get_build_events_public_tmp_job_accessible_by_any_auth_user(
    ...
    monkeypatch.setattr(terraflow.api.v1.chat, "get_flow_events_response", mock_get_flow_events_response)
...
def _stub_start_flow_build(monkeypatch, captured: dict) -> None:
    ...
    import terraflow.api.v1.chat as chat_module
...
def test_scope_session_to_namespace_helper():
    from terraflow.api.utils import scope_session_to_namespace
