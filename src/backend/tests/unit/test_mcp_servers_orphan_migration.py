"""Tests for migrate_orphaned_mcp_servers_config in terraflow.services.utils.
...
from terraflow.services.utils import migrate_orphaned_mcp_servers_config
...
async def initialized_services(monkeypatch, tmp_path):
    ...
    monkeypatch.setenv("TERRAFLOW_CONFIG_DIR", str(config_dir))
