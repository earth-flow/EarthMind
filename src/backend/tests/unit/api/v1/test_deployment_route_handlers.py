...
from terraflow.api.v1.deployments import DeploymentTelemetryCtx
...
ROUTES_MODULE = "terraflow.api.v1.deployments"
HELPERS_MODULE = "terraflow.api.v1.mappers.deployments.helpers"
...
class TestCreateDeploymentRollback:
    ...
    async def test_rollback_called_on_commit_failure(
        ...
        from terraflow.api.v1.deployments import create_deployment
...
class TestListDeploymentsLoadFromProvider:
    ...
    async def test_load_from_provider_bypasses_db_view(
        ...
        from terraflow.api.v1.deployments import list_deployments
...
class TestListDeploymentsMetadataSync:
    ...
    async def test_provider_description_passed_and_display_name_stays_in_provider_data(
        ...
        def _apply_metadata_batch(*_args, **kwargs):
            ...
            update.terraflow_db_row.display_name = update.display_name
            update.terraflow_db_row.description = update.description
...
class TestConfigAndSnapshotListRoutes:
    ...
    async def test_list_configs_global_scope_uses_provider_id(
        ...
        from terraflow.api.v1.deployments import list_deployment_configs
    ...
    async def test_list_snapshots_deployment_scope_resolves_provider_from_deployment(
        ...
        from terraflow.api.v1.deployments import list_deployment_snapshots
...
class TestUpdateSnapshotRoute:
    @pytest.mark.asyncio
    @patch("terraflow.services.database.models.flow_version.crud.get_flow_version_entry", new_callable=AsyncMock)
    @patch("terraflow.services.database.models.deployment.crud.get_deployment", new_callable=AsyncMock)
    ...
    async def test_updates_all_attachment_rows_for_snapshot(
        ...
        from terraflow.api.v1.deployments import update_snapshot
...
class TestListDeploymentFlowVersionsRoute:
    ...
    async def test_returns_paginated_flow_versions(
        ...
        from terraflow.api.v1.deployments import list_deployment_flow_versions
...
class TestProviderAccountRoutes:
    ...
    async def test_update_provider_account_name_only_skips_credential_verification(
        ...
        from terraflow.api.v1.deployments import update_provider_account
    ...
    async def test_create_provider_account_conflict_returns_409(
        ...
        from terraflow.api.v1.deployments import create_provider_account
    ...
    async def test_delete_provider_account_rejects_when_deployments_exist(
        ...
        from terraflow.api.v1.deployments import delete_provider_account
    ...
    async def test_delete_provider_account_sets_deployment_provider_scope_for_reconciliation(
        ...
        """
        from terraflow.api.v1.deployments import delete_provider_account
        from terraflow.services.adapters.deployment.context import DeploymentProviderIDContext
...
class TestUpdateDeploymentRollback:
    ...
    async def test_rollback_called_on_commit_failure(
        ...
        from terraflow.api.v1.deployments import update_deployment
...
class TestGetDeploymentSync:
    ...
    async def test_stale_row_deleted_when_provider_returns_not_found(
        ...
        from terraflow.api.v1.deployments import get_deployment
        from terraflow.api.v1.mappers.deployments.base import BaseDeploymentMapper
...
class TestDeleteDeployment:
    ...
    async def test_provider_not_found_still_deletes_local_row(
        ...
        from terraflow.api.v1.deployments import delete_deployment
...
class TestListDeploymentLlms:
    ...
    async def test_list_llms_returns_shaped_response(
        ...
        from terraflow.api.v1.deployments import list_deployment_llms
...
class TestResolveDeploymentAdapter:
    def test_empty_provider_key_raises_400(self):
        from terraflow.api.v1.mappers.deployments.helpers import resolve_deployment_adapter
...
class TestHandleAdapterErrors:
    def test_maps_authentication_error_to_401(self):
        from terraflow.api.v1.mappers.deployments.helpers import handle_adapter_errors
