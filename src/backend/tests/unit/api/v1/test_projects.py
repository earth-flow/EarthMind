...
class TestProjectMCPIntegration:
    ...
    def mock_mcp_settings_enabled(self):
        ...
        with patch("terraflow.api.v1.projects.get_settings_service") as mock_get_settings:
    ...
    async def test_create_project_with_mcp_auto_add_enabled_success(
        ...
        with (
            patch("terraflow.api.v1.projects.get_settings_service") as mock_get_settings,
            patch("terraflow.api.v1.projects_mcp_helpers.get_project_streamable_http_url") as mock_streamable_url,
            patch("terraflow.api.v1.projects_mcp_helpers.validate_mcp_server_for_project") as mock_validate,
            patch("terraflow.api.v1.projects_mcp_helpers.update_server") as mock_update_server,
            patch("terraflow.api.v1.projects_mcp_helpers.create_api_key") as mock_create_api_key,
            patch("terraflow.api.v1.projects_mcp_helpers.get_storage_service") as mock_storage,
        ):
            # Setup mocks
    ...
    async def test_create_project_with_mcp_auto_add_enabled_success_legacy_sse(
        ...
        with (
            patch("terraflow.api.v1.projects.get_settings_service") as mock_get_settings,
            patch("terraflow.api.v1.mcp_projects.get_project_sse_url") as mock_sse_url,
            patch("terraflow.api.v1.projects_mcp_helpers.get_project_streamable_http_url") as mock_streamable_url,
            patch("terraflow.api.v1.projects_mcp_helpers.validate_mcp_server_for_project") as mock_validate,
            patch("terraflow.api.v1.projects_mcp_helpers.update_server") as mock_update_server,
            patch("terraflow.api.v1.projects_mcp_helpers.create_api_key") as mock_create_api_key,
    ...
    async def test_update_project_name_with_mcp_server_update(
        ...
        with (
            patch("terraflow.api.v1.projects.get_settings_service") as mock_get_settings,
            patch("terraflow.api.v1.projects_mcp_helpers.get_project_streamable_http_url"),
            patch("terraflow.api.v1.projects_mcp_helpers.validate_mcp_server_for_project") as mock_validate_create,
            patch("terraflow.api.v1.projects_mcp_helpers.update_server"),
            patch("terraflow.api.v1.projects_mcp_helpers.create_api_key"),
            patch("terraflow.api.v1.projects_mcp_helpers.get_storage_service"),
        ):
            # Mock settings to enable MCP auto-add
            mock_settings = MagicMock()
            mock_settings.settings.add_projects_to_mcp_servers = True
    ...
    async def test_create_project_auto_login_disabled_adds_api_key_auth(
        ...
        with patch("terraflow.api.v1.projects.get_settings_service") as mock_get_settings:
            ...
            with patch("terraflow.api.v1.projects.encrypt_auth_settings") as mock_encrypt:
...
async def test_download_file_starter_project(client: AsyncClient, logged_in_headers, active_user, json_flow):
    ...
    project_payload = {
        ...
        "description": "Starter projects to help you get started in Terraflow.",
        "flows_list": [],
        "components_list": [],
    }
