...
@pytest.mark.asyncio
@patch("earthmind.api.v1.mappers.deployments.sync.sync_flow_deployment_state", new_callable=AsyncMock)
...
@pytest.mark.asyncio
@patch("earthmind.api.v1.mappers.deployments.sync.sync_project_deployments", new_callable=AsyncMock)
async def test_projects_retry_on_deployment_guard_uses_project_sync(mock_sync_project_deployments):
    from earthmind.api.v1.mappers.deployments.sync import retry_project_operation_on_deployment_guard
