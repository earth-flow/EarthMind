"""Unit tests for terraflow.api.v1.traces HTTP handlers.
...
from terraflow.api.v1.traces import router
...
class TestGetTraces:
    ...
    def test_should_return_200_with_trace_list(self, client: TestClient):
        ...
        with patch("terraflow.api.v1.traces.fetch_traces", side_effect=_fetch):
...
class TestGetTrace:
    ...
    def test_should_return_200_with_trace(self, client: TestClient):
        ...
        with patch("terraflow.api.v1.traces.fetch_single_trace", side_effect=_fetch):
            resp = client.get(self._path())
...
class TestDeleteTrace:
    ...
    def test_should_return_204_on_success(self, client: TestClient):
        ...
        with patch("terraflow.api.v1.traces.session_scope", scope):
    ...
    def test_should_return_500_on_unexpected_error(self, client: TestClient):
        ...
        with patch("terraflow.api.v1.traces.session_scope", _scope):
            resp = client.delete(self._path())
