...
import pytest
from terraflow.api.utils import get_suggestion_message, remove_api_keys
from terraflow.api.utils.core import build_content_disposition
from terraflow.services.database.models.flow.utils import get_outdated_components
...
def test_get_outdated_components():
    ...
    with patch(
        "terraflow.services.database.models.flow.utils.get_components_versions", return_value=mock_component_versions
    ):
