...
from terraflow.api.v2.registration import (
    RegisterRequest,
    RegisterResponse,
...
class TestHelperFunctions:
    ...
    @patch("terraflow.api.v2.registration.REGISTRATION_FILE")
    ...
    @patch("terraflow.api.v2.registration.REGISTRATION_FILE")
    @patch("terraflow.api.v2.registration.logger")
    ...
    @patch("terraflow.api.v2.registration._ensure_registration_file")
    @patch("terraflow.api.v2.registration.load_registration")
    @patch("terraflow.api.v2.registration.REGISTRATION_FILE")
    @patch("terraflow.api.v2.registration.logger")
...
class TestAPIEndpoints:
    ...
    @pytest.mark.asyncio
    @patch("terraflow.api.v2.registration.save_registration")
...
class TestIntegration:
    ...
    def test_full_registration_flow(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("terraflow.api.v2.registration.REGISTRATION_FILE", test_file)
