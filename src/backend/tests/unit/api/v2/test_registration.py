...
from earthmind.api.v2.registration import (
    RegisterRequest,
    RegisterResponse,
...
class TestHelperFunctions:
    ...
    @patch("earthmind.api.v2.registration.REGISTRATION_FILE")
    ...
    @patch("earthmind.api.v2.registration.REGISTRATION_FILE")
    @patch("earthmind.api.v2.registration.logger")
    ...
    @patch("earthmind.api.v2.registration._ensure_registration_file")
    @patch("earthmind.api.v2.registration.load_registration")
    @patch("earthmind.api.v2.registration.REGISTRATION_FILE")
    @patch("earthmind.api.v2.registration.logger")
...
class TestAPIEndpoints:
    ...
    @pytest.mark.asyncio
    @patch("earthmind.api.v2.registration.save_registration")
...
class TestIntegration:
    ...
    def test_full_registration_flow(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("earthmind.api.v2.registration.REGISTRATION_FILE", test_file)
