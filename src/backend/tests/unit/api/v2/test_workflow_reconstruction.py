...
class TestWorkflowReconstruction:
    ...
    async def test_reconstruct_success_with_terminal_nodes(self):
        ...
        with (
            patch("earthmind.api.v2.workflow_reconstruction.get_vertex_builds_by_job_id") as mock_get_vb,
            patch("earthmind.api.v2.workflow_reconstruction.Graph") as mock_graph_class,
            patch("earthmind.api.v2.workflow_reconstruction.run_response_to_workflow_response") as mock_converter,
        ):
    ...
    async def test_reconstruct_fails_when_no_vertex_builds(self):
        ...
        with patch("earthmind.api.v2.workflow_reconstruction.get_vertex_builds_by_job_id") as mock_get_vb:
