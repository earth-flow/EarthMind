"""Unit tests for terraflow.services.tracing.repository.
...
import pytest
from terraflow.services.tracing.formatting import TraceSummaryData
...
class TestFetchTraceSummaryData:
    ...
    async def test_should_return_empty_dict_for_no_trace_ids(self):
        from terraflow.services.tracing.repository import fetch_trace_summary_data
