...
class TestS3StorageParseFilePath:
    ...
    def test_parse_nested_flow_id(self):
        ...
        flow_id, file_name = service.parse_file_path(
            "files-test-1/afffa27a-a9f0-4511-b1a9-7e6cb2b3df05/2025-12-07_14-47-29_earthmind_pid_mem_usage.png"
        )
        assert flow_id == "afffa27a-a9f0-4511-b1a9-7e6cb2b3df05"
        assert file_name == "2025-12-07_14-47-29_earthmind_pid_mem_usage.png"
    ...
    def test_parse_nested_flow_id_without_prefix(self):
        ...
        flow_id, file_name = service.parse_file_path(
            "afffa27a-a9f0-4511-b1a9-7e6cb2b3df05/2025-12-07_14-47-29_earthmind_pid_mem_usage.png"
        )
        assert flow_id == "afffa27a-a9f0-4511-b1a9-7e6cb2b3df05"
        assert file_name == "2025-12-07_14-47-29_earthmind_pid_mem_usage.png"
...
class TestLocalStorageParseFilePathWindowsCompatibility:
    ...
    def test_parse_windows_uuid_flow_id(self):
        ...
        mock_session = Mock()
        mock_settings = Mock()
        mock_settings.settings.config_dir = "C:\\Users\\user\\AppData\\Local\\earthmind"

        service = LocalStorageService(mock_session, mock_settings)

        flow_id, file_name = service.parse_file_path(
            "C:\\Users\\user\\AppData\\Local\\earthmind\\afffa27a-a9f0-4511-b1a9-7e6cb2b3df05\\uploaded_file.png"
        )
        assert flow_id == "afffa27a-a9f0-4511-b1a9-7e6cb2b3df05"
