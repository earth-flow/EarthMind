...
import pytest
from terraflow.services.database.models.flow import Flow as FlowTable
...
from terraflow.services.task.temp_flow_cleanup import (
    CleanupWorker,
...
async def test_cleanup_worker_run_with_exception(mocker):
    ...
    mock_logger = mocker.patch("terraflow.services.task.temp_flow_cleanup.logger")
