...
4. Verifying the workflow works with terraflow's dependencies
"""
...
class TestAgentInLfxRun:
    ...
    def simple_agent_script_content(self):
        ...
        return '''"""A simple agent flow example for Terraflow.

This script demonstrates how to set up a conversational agent using Terraflow's
...
'''
    ...
    def test_agent_script_file_validation(self, simple_agent_script_file):
        ...
        # Since we don't have direct CLI access in terraflow tests,
    ...
    def test_logging_configuration(self):
        ...
        if isinstance(log_config, dict):
            ...
            assert log_config.get("log_file") == Path("terraflow.log")
        else:
