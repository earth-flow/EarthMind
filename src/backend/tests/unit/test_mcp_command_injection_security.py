...
import pytest
from terraflow.api.v2.schemas import ALLOWED_MCP_COMMANDS, DANGEROUS_ENV_VARS, MCPServerConfig
...
class TestMCPCommandInjectionSecurity:
    ...
    def test_poc_touch_command_rejected(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            MCPServerConfig(command="touch", args=["/tmp/pwned_terraflow"])  # noqa: S108
