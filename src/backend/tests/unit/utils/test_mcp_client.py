...
# ---------------------------------------------------------------------------
# TerraflowClient — pure method tests (no network)
# ---------------------------------------------------------------------------


class TestClientHeaders:
    def test_no_credentials(self):
        client = TerraflowClient(server_url="http://test:7860")
        client.api_key = None
    ...
    def test_api_key_only(self):
        client = TerraflowClient(server_url="http://test:7860", api_key="sk-test-key")
        headers = client._headers()
        assert "Authorization" not in headers
    ...
    def test_both_token_and_api_key(self):
        ...
        client = TerraflowClient(server_url="http://test:7860", api_key="sk-key")
...
class TestClientUrl:
    def test_basic_path(self):
        client = TerraflowClient(server_url="http://localhost:7860")
    ...
    def test_nested_path(self):
        client = TerraflowClient(server_url="http://host:8000")
...
class TestClientInit:
    ...
    def test_custom_server_url(self):
        client = TerraflowClient(server_url="http://custom:9000")
