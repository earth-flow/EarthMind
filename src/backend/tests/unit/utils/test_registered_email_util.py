...
import pytest
from earthmind.services.telemetry.schema import EmailPayload
from earthmind.utils.registered_email_util import _RegisteredEmailCache, get_email_model
...
class TestGetEmailModel:
    ...
    def test_get_email_model_success(self):
        ...
        with patch("earthmind.utils.registered_email_util.load_registration") as mock_load_registration:
