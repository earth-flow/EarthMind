...
import pytest
from terraflow.services.telemetry.schema import EmailPayload
from terraflow.utils.registered_email_util import _RegisteredEmailCache, get_email_model
...
class TestGetEmailModel:
    ...
    def test_get_email_model_success(self):
        ...
        with patch("terraflow.utils.registered_email_util.load_registration") as mock_load_registration:
