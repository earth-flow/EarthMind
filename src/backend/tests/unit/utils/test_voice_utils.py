...
import numpy as np
import pytest
from terraflow.utils.voice_utils import (
    BYTES_PER_16K_FRAME,
    BYTES_PER_24K_FRAME,
    BYTES_PER_SAMPLE,
    FRAME_DURATION_MS,
...
class TestResample24kTo16k:
    ...
    @patch("terraflow.utils.voice_utils.resample")
...
class TestWriteAudioToFile:
    ...
    async def test_write_audio_to_file_success(self):
        ...
        with (
            patch("terraflow.utils.voice_utils.asyncio.to_thread") as mock_to_thread,
            patch("terraflow.utils.voice_utils.logger") as mock_logger,
        ):
    ...
    async def test_write_audio_to_file_default_filename(self):
        ...
        with patch("terraflow.utils.voice_utils.asyncio.to_thread") as mock_to_thread:
            mock_to_thread.return_value = None
    ...
    async def test_write_audio_to_file_base64_decode_error(self):
        ...
        with patch("terraflow.utils.voice_utils.logger") as mock_logger:
...
class TestWriteBytesToFile:
    ...
    def test_write_bytes_to_file_success(self):
        ...
        mock_file = mock_open()
        with patch("terraflow.utils.voice_utils.Path.open", mock_file):
    ...
    def test_write_bytes_to_file_path_construction(self):
        ...
        with patch("terraflow.utils.voice_utils.Path") as mock_path:
