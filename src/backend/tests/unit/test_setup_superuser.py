...
# @patch("terraflow.services.deps.get_session")
# @patch("terraflow.services.utils.create_super_user")
# @patch("terraflow.services.deps.get_settings_service")
# # @patch("terraflow.services.utils.verify_password")
...
async def test_create_super_user_race_condition():
    ...
    with (
        patch("terraflow.services.auth.service.get_user_by_username", mock_get_user_by_username),
        patch("terraflow.services.auth.utils.get_password_hash", mock_get_password_hash),
        patch("terraflow.services.database.models.user.model.User") as mock_user_class,
    ):
...
async def test_create_super_user_race_condition_no_user_found():
    ...
    with (
        patch("terraflow.services.auth.service.get_user_by_username", mock_get_user_by_username),
        patch("terraflow.services.auth.utils.get_password_hash", mock_get_password_hash),
        patch("terraflow.services.database.models.user.model.User", return_value=mock_user),
...
async def test_create_super_user_concurrent_workers():
    ...
    with patch("terraflow.services.auth.service.get_user_by_username", mock_get_user_by_username):
