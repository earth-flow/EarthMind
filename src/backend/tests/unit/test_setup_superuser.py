...
# @patch("earthmind.services.deps.get_session")
# @patch("earthmind.services.utils.create_super_user")
# @patch("earthmind.services.deps.get_settings_service")
# # @patch("earthmind.services.utils.verify_password")
...
async def test_create_super_user_race_condition():
    ...
    with (
        patch("earthmind.services.auth.service.get_user_by_username", mock_get_user_by_username),
        patch("earthmind.services.auth.utils.get_password_hash", mock_get_password_hash),
        patch("earthmind.services.database.models.user.model.User") as mock_user_class,
    ):
...
async def test_create_super_user_race_condition_no_user_found():
    ...
    with (
        patch("earthmind.services.auth.service.get_user_by_username", mock_get_user_by_username),
        patch("earthmind.services.auth.utils.get_password_hash", mock_get_password_hash),
        patch("earthmind.services.database.models.user.model.User", return_value=mock_user),
...
async def test_create_super_user_concurrent_workers():
    ...
    with patch("earthmind.services.auth.service.get_user_by_username", mock_get_user_by_username):
