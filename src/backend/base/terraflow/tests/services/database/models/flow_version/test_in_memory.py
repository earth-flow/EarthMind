...
import pytest
from terraflow.api.utils.flow_utils import cascade_delete_flow
from terraflow.services.database.models.deployment.crud import list_deployments_page
from terraflow.services.database.models.deployment.guards import (
...
class TestVersionPruningRespectsLiveDeployments:
    async def test_orphan_attachment_does_not_pin_version_during_pruning(
        ...
        with patch(
            "terraflow.services.database.models.flow_version.crud.get_settings_service",
