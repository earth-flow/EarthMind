...
def create_terraflow_progress(*, verbose: bool = False) -> ProgressIndicator:
    """Create a progress indicator with predefined Terraflow initialization steps."""
    progress = ProgressIndicator(verbose=verbose)

    # Define the initialization steps matching the order in main.py
    steps = [
        ("Initializing Terraflow", "Setting up basic configuration"),
        ...
        ("Launching Terraflow", "Starting server and final setup"),
    ]
...
def create_terraflow_shutdown_progress(*, verbose: bool = False, multiple_workers: bool = False) -> ProgressIndicator:
    """Create a progress indicator with predefined Terraflow shutdown steps."""
    progress = ProgressIndicator(verbose=verbose)
