...
spawned by stdio_client during Terraflow shutdown.
...
async def cleanup_mcp_sessions() -> None:
    ...
    with contextlib.suppress(Exception):
        ...
        from terraflow.services.deps import get_shared_component_cache_service
...
async def _kill_mcp_processes() -> None:
    """Kill MCP server subprocesses spawned by this Terraflow process.
