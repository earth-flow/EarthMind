...
def _get_version_info():
    ...
    package_options = [
        ("terraflow", "Terraflow"),
        ("terraflow-base", "Terraflow Base"),
        ("terraflow-nightly", "Terraflow Nightly"),
        ("terraflow-base-nightly", "Terraflow Base Nightly"),
    ]
    __version__ = None
    for pkg_name, display_name in package_options:
        try:
            ...
            # The canonical `terraflow` / `terraflow-base` distribution matches first, and the
