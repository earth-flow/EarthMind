...
from terraflow.services.database.models.message.model import MessageRead, MessageTable
...
async def aadd_messages(
    ...
    # Check if all messages are Message instances (either from terraflow or lfx)
    for message in messages:
        # Accept Message instances from both terraflow and lfx packages
