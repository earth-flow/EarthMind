...
from terraflow.api.disconnect import DisconnectHandlerStreamingResponse
...
from terraflow.schema.message import ErrorMessage
        ...
        if event_delivery != EventDeliveryType.POLLING:
            ...
            raise HTTPException(
                ...
                detail=(
                    ...
                    "set TERRAFLOW_EVENT_DELIVERY to override the default."
                ),
            )
