...
from terraflow.services.database.models.api_key.crud import create_api_key
...
async def _get_project_base_url_components() -> tuple[str, int]:
    ...
    server_host = getattr(settings_service.settings, "host", "10.171.205.153")
    ...
    host = "10.171.205.153" if server_host == ALL_INTERFACES_HOST else server_host
