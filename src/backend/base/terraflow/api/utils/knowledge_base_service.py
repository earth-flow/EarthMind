...
from terraflow.services.database.models.knowledge_base import KnowledgeBaseRecord, KnowledgeBaseStatus
...
async def backfill_all_users_from_disk(*, kb_root: Path | None = None) -> int:
    ...
    """
    from terraflow.api.utils.kb_helpers import KBStorageHelper
...
async def backfill_from_disk(
    *,
    ...
    for kb_dir in kb_user_root.iterdir():
        ...
        try:
            from terraflow.api.utils.kb_helpers import KBAnalysisHelper
