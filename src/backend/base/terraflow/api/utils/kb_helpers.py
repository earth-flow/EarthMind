...
from terraflow.api.utils import CurrentActiveUser
from terraflow.api.utils.kb_processing import process_knowledge_document
...
class KBIngestionHelper:
    ...
    async def perform_ingestion(
        ...
        CANCELLED.
        """
        # Lazy import: the service reaches into terraflow DB plumbing we
        ...
        from terraflow.api.utils.knowledge_base_service import (
            get_embedding_model,
        ...
        try:
            ...
            backend = create_backend(
                ...
                # pull their connection URI / tokens from Terraflow's
