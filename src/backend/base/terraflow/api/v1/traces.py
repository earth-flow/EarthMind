...
Business logic (query/aggregation) lives in:
    terraflow.services.tracing.repository

Data transformation logic lives in:
    terraflow.services.tracing.formatting
"""
...
from terraflow.services.tracing.repository import fetch_single_trace, fetch_traces
