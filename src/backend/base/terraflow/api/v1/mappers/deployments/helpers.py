...
from terraflow.services.database.utils import require_non_empty

if TYPE_CHECKING:
    from collections.abc import Sequence

    from terraflow.api.utils import DbSession
...
# ---------------------------------------------------------------------------
# Route helpers (moved from terraflow.api.v1.deployments)
# ---------------------------------------------------------------------------
...
async def resolve_adapter_mapper_from_provider_id(
    ...
    *,
    ...
    from terraflow.api.v1.mappers.deployments.registry import get_deployment_mapper
...
async def get_deployment_row_or_404(
    *,
    ...
    # registered and ``TERRAFLOW_AUTHZ_ENABLED`` is on; otherwise it stays
