...
class DeploymentApiPayloads(DeploymentPayloadFields):
    ...
    Ownership boundary:
    Terraflow owns API slot population here because API payloads may include
    Terraflow-specific references and reshaping requirements. Adapter-side
...
class BaseDeploymentMapper:
    ...
    - Mapper: API-boundary translation/validation (Terraflow schemas <-> adapter payloads).
    ...
    Terraflow-aware resolution or payload reshaping.
    """
