...
from terraflow.api.utils.mcp.config_utils import validate_mcp_server_for_project
from terraflow.api.v1.mcp_projects import get_project_streamable_http_url
...
from terraflow.services.deps import get_service, get_settings_service, get_storage_service
...
def _server_config_has_project_api_key(args: list[Any]) -> bool:
    """Return whether the server args include the generated Terraflow API key header."""
    return any(
