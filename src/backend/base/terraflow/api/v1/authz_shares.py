...
from terraflow.api.v1.schemas.authz_shares import ShareCreate, ShareRead, ShareUpdate
from terraflow.services.authorization import ShareAction, ensure_share_permission
from terraflow.services.authorization.utils import audit_decision
from terraflow.services.database.models.auth import AuthzShare, AuthzTeamMember, SharePermissionLevel, ShareScope
...
from terraflow.services.database.models.variable.model import Variable
...
async def _ensure_can_administer_share(
    *,
    ...
    if await authz.supports_cross_user_fetch() and await authz.is_enabled():
        ...
        # TerraflowAuthorizationService), so this early-return is dead and the
