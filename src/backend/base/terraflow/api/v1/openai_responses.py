...
from terraflow.api.v1.endpoints import consume_and_yield, run_flow_generator, simple_run_flow
...
from terraflow.schema import (
    OpenAIErrorResponse,
    OpenAIResponsesRequest,
    OpenAIResponsesResponse,
    OpenAIResponsesStreamChunk,
)
from terraflow.schema.content_types import ToolContent
...
from terraflow.services.deps import get_telemetry_service
    ...
    *,
    ...
    if stream:
        ...
        async def openai_stream_generator() -> AsyncGenerator[str, None]:
            """Convert Terraflow events to OpenAI Responses API streaming format."""
...
async def create_response(
    ...
    the input through the specified Terraflow flow.
    ...
    # Extract global variables from X-TERRAFLOW-GLOBAL-VAR-* headers
