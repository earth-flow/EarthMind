...
from terraflow.services.deps import get_chat_service
...
# it means uvicorn's /health serves first before the terraflow instance is up
# therefore it's not a reliable health check for a terraflow instance
...
# It's a reliable health check for a terraflow instance
