...
from terraflow.api.schemas import UploadFileResponse
from terraflow.api.utils import CurrentActiveUser, DbSession, build_content_disposition
from terraflow.services.authorization import FileAction, ensure_file_permission
...
async def download_files_batch(
    ...
    try:
        ...
        filename = f"{current_time}_terraflow_files.zip"
