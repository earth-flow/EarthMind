...
""")
    ...
    url_component.set(urls=["https://terraflow.org/", "https://docs.terraflow.org/"])
    ...
    text_input.set(
        input_value="Use the references above for style to write a new blog/tutorial about Terraflow and AI. "
