...
TERRAFLOW_ASSISTANT_FLOW = "TerraflowAssistant.json"
...
OFF_TOPIC_REFUSAL_MESSAGE = (
    "I appreciate your interest, but I'm the Terraflow Assistant and can only help with "
    "Terraflow-related topics such as building components, creating flows, configuring "
    "deployments, and troubleshooting issues. Could you rephrase your question about Terraflow?"
)
...
FLOW_VERIFICATION_ENABLED_ENV = "TERRAFLOW_ASSISTANT_VERIFY_FLOWS"
...
Respond with a complete, valid Terraflow component as a Python class extending Component, \
