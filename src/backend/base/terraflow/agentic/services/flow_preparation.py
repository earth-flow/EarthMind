...
import lfx
from terraflow.agentic.helpers.assistant_workspace import resolve_assistant_fs_root

# Relative path embedded in the bundled TerraflowAssistant.json flow for the
...
# case for a packaged install (Terraflow Desktop, `pip install terraflow`,
...
def inject_lfx_components_path(flow_data: dict) -> dict:
    ...
    The bundled TerraflowAssistant flow hardcodes a relative path that only
    ...
    be a directory.", causing the Terraflow Assistant to fail with
