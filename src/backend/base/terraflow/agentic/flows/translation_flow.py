...
Usage:
    from terraflow.agentic.flows.translation_flow import get_graph
...
- "generate_component": User wants you to CREATE/BUILD/GENERATE/MODIFY a custom Terraflow component.
...
- "question": User is ASKING A QUESTION about Terraflow, seeking help with Terraflow, wants \
information about Terraflow features/components/flows, OR is just being conversational \
...
- "off_topic": The request is NOT about Terraflow AND is not a social pleasantry. It is a \
SUBSTANTIVE question/task about other tools, platforms, or general knowledge unrelated to Terraflow.
...
"question" (answer it briefly and warmly). off_topic is ONLY for substantive non-Terraflow topics.

IMPORTANT rules:
- "How to create a component" = question (asking for Terraflow guidance)
...
- General knowledge questions NOT related to Terraflow = off_topic
...
- If unsure whether it's about Terraflow, classify as "question" (not off_topic)
...
- "how do I create a file?" / "how to save files in Terraflow" = question (asking for guidance)
...
Examples:
Input: "como criar um componente no terraflow"
Output: {{"translation": "how to create a component in terraflow", "intent": "question"}}
...
Input: "how do I save a file in Terraflow?"
Output: {{"translation": "how do I save a file in Terraflow?", "intent": "question"}}
