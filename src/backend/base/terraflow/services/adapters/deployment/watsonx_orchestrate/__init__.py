...
def __getattr__(name: str):
    if name == "WatsonxOrchestrateDeploymentService":
        from terraflow.services.adapters.deployment.watsonx_orchestrate.service import (
            WatsonxOrchestrateDeploymentService,
        )

        return WatsonxOrchestrateDeploymentService
    if name == "WxOCredentials":
        from terraflow.services.adapters.deployment.watsonx_orchestrate.types import WxOCredentials
