...
from terraflow.services.adapters.deployment.watsonx_orchestrate.core.shared import (
...
from terraflow.services.adapters.deployment.watsonx_orchestrate.core.tools import (
    ...
    ensure_terraflow_connections_binding,
    to_writable_tool_payload,
    verify_terraflow_owned,
)
from terraflow.services.adapters.deployment.watsonx_orchestrate.payloads import (
    ...
    build_terraflow_wxo_resource_name,
...
async def _update_existing_tools(
    *,
    ...
    for tool_id in rename_tool_ids:
        ...
        writable_tool["name"] = build_terraflow_wxo_resource_name(tool_display_name, resource="Tool")
...
def build_update_payload_from_spec(
    ...
    *,
    ...
    if "display_name" in update_payload and "name" not in update_payload:
        update_payload["name"] = build_terraflow_wxo_resource_name(update_payload["display_name"], resource="Agent")
