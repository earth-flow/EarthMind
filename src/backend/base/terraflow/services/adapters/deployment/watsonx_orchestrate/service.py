...
from terraflow.services.adapters.deployment.watsonx_orchestrate.client import get_authenticator, get_provider_clients
from terraflow.services.adapters.deployment.watsonx_orchestrate.constants import (
    SUPPORTED_ADAPTER_DEPLOYMENT_TYPES,
    ErrorPrefix,
)
from terraflow.services.adapters.deployment.watsonx_orchestrate.core.config import (
    list_configs as list_adapter_configs,
)
from terraflow.services.adapters.deployment.watsonx_orchestrate.core.create import (
    apply_provider_create_plan_with_rollback,
    build_provider_create_plan,
    validate_provider_create_request_sections,
)
from terraflow.services.adapters.deployment.watsonx_orchestrate.core.execution import (
    create_agent_run,
    get_agent_run,
)
from terraflow.services.adapters.deployment.watsonx_orchestrate.core.models import (
    fetch_models_adapter,
)
from terraflow.services.adapters.deployment.watsonx_orchestrate.core.retry import (
    retry_update,
    rollback_created_resources,
)
from terraflow.services.adapters.deployment.watsonx_orchestrate.core.status import (
...
from terraflow.services.adapters.deployment.watsonx_orchestrate.core.tools import (
    ...
    extract_terraflow_connections_binding,
    upload_tool_artifact_bytes,
    verify_tools_by_ids,
)
from terraflow.services.adapters.deployment.watsonx_orchestrate.core.update import (
...
class WatsonxOrchestrateDeploymentService(BaseDeploymentService):
    ...
    async def update_snapshot(
        ...
        *,
        ...
        Terraflow flow name. This is intentional: the user may have set a
        ...
        * **Tool renamed in wxO console** — The new name is picked up
          ...
          Terraflow never stores the tool name locally.
        ...
        **Blast-radius boundary:** callers must verify that ``snapshot_id``
        is tracked by a Terraflow attachment record before calling this
        ...
        # been deployed with a custom name that differs from the Terraflow flow
