...
from terraflow.exceptions.api import WorkflowResourceError, WorkflowServiceUnavailableError
from terraflow.services.base import Service
from terraflow.services.deps import get_queue_service
from terraflow.services.task.backends.anyio import AnyIOBackend
from terraflow.services.task.backends.celery import CeleryBackend

if TYPE_CHECKING:
    from lfx.services.settings.service import SettingsService

    from terraflow.services.task.backends.base import TaskBackend
...
class TaskService(Service):
    ...
    async def revoke_task(self, task_id: UUID | str) -> bool:
        ...
        try:
            ...
            if str(e) != "TERRAFLOW_USER_CANCELLED":
                raise
            return True
        return True
