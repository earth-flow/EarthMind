...
def import_all_services_into_a_dict():
    # Services are all in terraflow.services.{service_name}.service
    ...
    for service_type in ServiceType:
        try:
            ...
            if service_name == "mcp_composer":
                ...
                module_name = f"terraflow.services.{service_name}.service"
    ...
    # Import settings and auth bases from lfx (used in type hints but not terraflow Service subclasses)
