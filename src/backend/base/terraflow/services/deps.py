...
if TYPE_CHECKING:
    ...
    from terraflow.services.cache.service import AsyncBaseCacheService, CacheService
    from terraflow.services.chat.service import ChatService
    from terraflow.services.database.service import DatabaseService
    from terraflow.services.session.service import SessionService
    from terraflow.services.state.service import StateService
    from terraflow.services.store.service import StoreService
    from terraflow.services.task.service import TaskService
    from terraflow.services.tracing.service import TracingService
    from terraflow.services.variable.service import VariableService
...
from terraflow.services.job_queue.service import JobQueueService  # noqa: TC001
from terraflow.services.storage.service import StorageService  # noqa: TC001
from terraflow.services.telemetry.service import TelemetryService  # noqa: TC001
...
def get_service(service_type: ServiceType, default=None):
    ...
    if not service_manager.are_factories_registered():
        ...
        from terraflow.services.manager import ServiceManager
...
def get_telemetry_service() -> TelemetryService:
    ...
    """
    from terraflow.services.telemetry.factory import TelemetryServiceFactory
...
def get_tracing_service() -> TracingService:
    ...
    """
    from terraflow.services.tracing.factory import TracingServiceFactory
...
def get_state_service() -> StateService:
    ...
    """
    from terraflow.services.state.factory import StateServiceFactory
...
def get_storage_service() -> StorageService:
    ...
    """
    from terraflow.services.storage.factory import StorageServiceFactory
...
def get_variable_service() -> VariableService:
    ...
    """
    from terraflow.services.variable.factory import VariableServiceFactory
...
def get_db_service() -> DatabaseService:
    ...
    """
    from terraflow.services.database.factory import DatabaseServiceFactory
...
def get_shared_component_cache_service() -> CacheService:
    ...
    Returns:
        The cache service instance.
    """
    from terraflow.services.shared_component_cache.factory import SharedComponentCacheServiceFactory
...
def get_session_service() -> SessionService:
    ...
    """
    from terraflow.services.session.factory import SessionServiceFactory
...
def get_task_service() -> TaskService:
    ...
    """
    from terraflow.services.task.factory import TaskServiceFactory
...
def get_queue_service() -> JobQueueService:
    ...
    from terraflow.services.job_queue.factory import JobQueueServiceFactory
...
def get_auth_service() -> BaseAuthService:
    ...
    from terraflow.services.auth.factory import AuthServiceFactory
...
def get_job_service():
    ...
    """
    from terraflow.services.jobs.factory import JobServiceFactory

    return get_service(ServiceType.JOB_SERVICE, JobServiceFactory())


def get_flow_events_service():
    from terraflow.services.flow_events.factory import FlowEventsServiceFactory
...
def get_memory_base_service():
    ...
    from terraflow.services.memory_base.factory import MemoryBaseServiceFactory

    return get_service(ServiceType.MEMORY_BASE_SERVICE, MemoryBaseServiceFactory())


def get_telemetry_writer_service():
    """Return the TelemetryWriterService instance (always registered when terraflow is installed)."""
    from terraflow.services.telemetry_writer.factory import TelemetryWriterServiceFactory
