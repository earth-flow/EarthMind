...
class OpenlayerTracer(BaseTracer):
    ...
    def add_trace(
        ...
        # Map Terraflow trace_type to Openlayer StepType
    ...
    def _convert_to_openlayer_type(self, value: Any) -> Any:
        """Convert Terraflow/LangChain types to Openlayer-compatible primitives.
    ...
    def _get_config(trace_name: str | None = None) -> dict:
        ...
        2. JSON mapping: OPENLAYER_TERRAFLOW_MAPPING
        ...
        if not inference_pipeline_id:
            mapping_json = os.getenv("OPENLAYER_TERRAFLOW_MAPPING")
