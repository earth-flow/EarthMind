...
from terraflow.services.cache.base import (
...
def _warn_redis_experimental_once() -> None:
    ...
    sentinel = Path(tempfile.gettempdir()) / f"terraflow_redis_cache_warned_{os.getppid()}.sentinel"
    try:
