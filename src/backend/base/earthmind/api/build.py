...
from earthmind.api.disconnect import DisconnectHandlerStreamingResponse
...
from earthmind.schema.message import ErrorMessage
        ...
        if event_delivery != EventDeliveryType.POLLING:
            ...
            raise HTTPException(
                ...
                detail=(
                    ...
                    "set EARTHMIND_EVENT_DELIVERY to override the default."
                ),
            )
