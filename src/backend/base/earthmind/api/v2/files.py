...
from earthmind.api.schemas import UploadFileResponse
from earthmind.api.utils import CurrentActiveUser, DbSession, build_content_disposition
from earthmind.services.authorization import FileAction, ensure_file_permission
...
async def download_files_batch(
    ...
    try:
        ...
        filename = f"{current_time}_earthmind_files.zip"
