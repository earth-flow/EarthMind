...
Business logic (query/aggregation) lives in:
    earthmind.services.tracing.repository

Data transformation logic lives in:
    earthmind.services.tracing.formatting
"""
...
from earthmind.services.tracing.repository import fetch_single_trace, fetch_traces
