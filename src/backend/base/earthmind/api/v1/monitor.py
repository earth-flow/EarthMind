...
from earthmind.api.utils import DbSession, custom_params
from earthmind.api.utils.flow_utils import compute_virtual_flow_id
from earthmind.schema.message import MessageResponse
from earthmind.services.auth.utils import get_current_active_superuser, get_current_active_user
from earthmind.services.authorization import FlowAction, ensure_flow_permission
from earthmind.services.authorization.fetch import authorized_or_owner_scoped
from earthmind.services.database.models.flow.model import Flow
from earthmind.services.database.models.message.crud import (
    delete_messages_for_user,
    delete_messages_for_user_by_session,
    get_message_for_user,
    get_messages_for_user_by_session,
)
from earthmind.services.database.models.message.model import MessageRead, MessageTable, MessageUpdate
from earthmind.services.database.models.transactions.crud import transform_transaction_table_for_logs
from earthmind.services.database.models.transactions.model import TransactionLogsResponse, TransactionTable
...
from earthmind.services.database.models.vertex_builds.model import VertexBuildMapModel
from earthmind.services.deps import get_memory_base_service, get_tracing_service
from earthmind.services.tracing.langfuse import (
...
async def job_queue_metrics() -> dict:
    ...
    """
    from earthmind.services.deps import get_queue_service
