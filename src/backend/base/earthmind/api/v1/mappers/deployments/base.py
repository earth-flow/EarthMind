...
class DeploymentApiPayloads(DeploymentPayloadFields):
    ...
    Ownership boundary:
    EarthMind owns API slot population here because API payloads may include
    EarthMind-specific references and reshaping requirements. Adapter-side
...
class BaseDeploymentMapper:
    ...
    - Mapper: API-boundary translation/validation (EarthMind schemas <-> adapter payloads).
    ...
    EarthMind-aware resolution or payload reshaping.
    """
