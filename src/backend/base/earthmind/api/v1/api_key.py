...
from earthmind.api.v1.schemas import ApiKeyCreateRequest, ApiKeysResponse
from earthmind.services.auth import utils as auth_utils

# Assuming you have these methods in your service layer
from earthmind.services.database.models.api_key.crud import create_api_key, delete_api_key, get_api_keys
from earthmind.services.database.models.api_key.model import ApiKeyCreate, UnmaskedApiKeyRead
