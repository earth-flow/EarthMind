...
from earthmind.api.utils import CurrentActiveUser, check_earthmind_version
from earthmind.services.auth import utils as auth_utils
from earthmind.services.deps import get_settings_service, get_store_service
from earthmind.services.store.exceptions import CustomError
from earthmind.services.store.schema import (
...
async def share_component(
    ...
    try:
        await check_earthmind_version(component)
