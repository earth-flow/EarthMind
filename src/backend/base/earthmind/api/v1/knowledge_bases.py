...
from earthmind.api.utils import CurrentActiveUser, ingestion_run_service, knowledge_base_service
from earthmind.api.utils.kb_helpers import KBAnalysisHelper, KBIngestionHelper, KBStorageHelper
...
from earthmind.api.utils.kb_metadata import parse_per_file_metadata, parse_user_metadata
from earthmind.api.utils.kb_processing import (
    normalize_chunk_strategy,
    normalize_parser_strategy,
    process_knowledge_document,
)
from earthmind.api.v1.schemas import TaskResponse
...
from earthmind.services.authorization import (
    KnowledgeBaseAction,
    ensure_knowledge_base_permission,
)
from earthmind.services.database.models.jobs.model import JobStatus, JobType
from earthmind.services.database.models.knowledge_base.model import KnowledgeBaseRecord
from earthmind.services.deps import get_job_service, get_settings_service, get_task_service
from earthmind.services.jobs import DuplicateJobError
from earthmind.services.jobs.service import JobService
from earthmind.services.memory_base.kb_path_helpers import validate_kb_path
from earthmind.services.task.service import TaskService
from earthmind.utils.kb_constants import (
...
async def _guard_kb_action(
    *,
    ...
    ``EARTHMIND_AUTHZ_ENABLED=true``, the helper falls back to scanning every
    ...
    """
    from earthmind.services.authorization.utils import (
        _auth_context,
        _coerce_action,
        _resolve_authz_domain,
    )
    from earthmind.services.database.models.user.crud import get_user_by_id
    from earthmind.services.deps import get_authorization_service, session_scope
...
def _validate_kb_path_containment(kb_user_path: Path, kb_path: Path, kb_name: str, username: str) -> None:
    ...
    :func:`earthmind.services.memory_base.kb_path_helpers.validate_kb_path`
...
async def _delete_remote_backend_collection(
    *,
    ...
    delete the KB from EarthMind's UI at all. Before this, the backend
