...
from earthmind.api.v1.endpoints import consume_and_yield, run_flow_generator, simple_run_flow
...
from earthmind.schema import (
    OpenAIErrorResponse,
    OpenAIResponsesRequest,
    OpenAIResponsesResponse,
    OpenAIResponsesStreamChunk,
)
from earthmind.schema.content_types import ToolContent
...
from earthmind.services.deps import get_telemetry_service
    ...
    *,
    ...
    if stream:
        ...
        async def openai_stream_generator() -> AsyncGenerator[str, None]:
            """Convert EarthMind events to OpenAI Responses API streaming format."""
...
async def create_response(
    ...
    the input through the specified EarthMind flow.
    ...
    # Extract global variables from X-EARTHMIND-GLOBAL-VAR-* headers
