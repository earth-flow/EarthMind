...
def _get_version_info():
    ...
    package_options = [
        ("earthmind", "EarthMind"),
        ("earthmind-base", "EarthMind Base"),
        ("earthmind-nightly", "EarthMind Nightly"),
        ("earthmind-base-nightly", "EarthMind Base Nightly"),
    ]
    __version__ = None
    for pkg_name, display_name in package_options:
        try:
            ...
            # The canonical `earthmind` / `earthmind-base` distribution matches first, and the
