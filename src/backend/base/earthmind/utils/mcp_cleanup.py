...
spawned by stdio_client during EarthMind shutdown.
...
async def cleanup_mcp_sessions() -> None:
    ...
    with contextlib.suppress(Exception):
        ...
        from earthmind.services.deps import get_shared_component_cache_service
...
async def _kill_mcp_processes() -> None:
    """Kill MCP server subprocesses spawned by this EarthMind process.
