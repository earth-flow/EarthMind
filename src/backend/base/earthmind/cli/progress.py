...
def create_earthmind_progress(*, verbose: bool = False) -> ProgressIndicator:
    """Create a progress indicator with predefined EarthMind initialization steps."""
    progress = ProgressIndicator(verbose=verbose)

    # Define the initialization steps matching the order in main.py
    steps = [
        ("Initializing EarthMind", "Setting up basic configuration"),
        ...
        ("Launching EarthMind", "Starting server and final setup"),
    ]
...
def create_earthmind_shutdown_progress(*, verbose: bool = False, multiple_workers: bool = False) -> ProgressIndicator:
    """Create a progress indicator with predefined EarthMind shutdown steps."""
    progress = ProgressIndicator(verbose=verbose)
