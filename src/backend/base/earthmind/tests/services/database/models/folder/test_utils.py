...
from earthmind.services.database.models.folder.utils import create_default_folder_if_it_doesnt_exist
...
async def test_default_folder_creation_consults_guard_with_null_folder_flows(
    ...
    monkeypatch.setattr(
        "earthmind.services.database.models.folder.utils.ensure_flow_moves_allowed",
        guard_spy,
    )
