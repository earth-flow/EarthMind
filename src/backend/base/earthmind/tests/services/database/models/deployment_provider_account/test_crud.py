...
_ENCRYPT_TARGET = "earthmind.services.database.models.deployment_provider_account.crud.auth_utils"
_CRUD_LOGGER = "earthmind.services.database.models.deployment_provider_account.crud.logger"
