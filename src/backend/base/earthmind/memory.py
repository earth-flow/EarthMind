...
from earthmind.services.database.models.message.model import MessageRead, MessageTable
...
async def aadd_messages(
    ...
    # Check if all messages are Message instances (either from earthmind or lfx)
    for message in messages:
        # Accept Message instances from both earthmind and lfx packages
