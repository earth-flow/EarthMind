...
from earthmind.utils.kb_constants import MAX_CHUNK_OVERLAP, MAX_CHUNK_SIZE, MIN_CHUNK_OVERLAP, MIN_CHUNK_SIZE

_REQUIRED_BACKEND_CONFIG: dict[str, tuple[str, ...]] = {
    BackendType.OPENSEARCH.value: ("index_name",),
    BackendType.MILVUS.value: ("collection_name",),
}
...
class CreateKnowledgeBaseRequest(BaseModel):
    ...
    chunk_strategy: str = "heading_markdown"
    ...
    mineru_timeout_s: float | None = None
    mineru_poll_attempts: int | None = None
    mineru_poll_interval_s: float | None = None
