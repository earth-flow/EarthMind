...
class CollectingSpanProcessor(SpanProcessor):
    ...
    def on_start(self, span, parent_context=None):
        ...
        if span.name in ("EarthMind", "Language Model"):
            span.set_attribute("earthmind.correlation_id", self.correlation_id)
...
class ArizePhoenixTracer(BaseTracer):
    ...
    def __init__(
        ...
        try:
            ...
            self.root_span.set_attribute("earthmind.trace_name", self.trace_name)
            self.root_span.set_attribute("earthmind.trace_type", self.trace_type)
            self.root_span.set_attribute("earthmind.project_name", self.project_name)
            self.root_span.set_attribute("earthmind.trace_id", str(self.trace_id))
            self.root_span.set_attribute("earthmind.session_id", str(self.session_id))
            self.root_span.set_attribute("earthmind.flow_name", self.flow_name)
            self.root_span.set_attribute("earthmind.flow_id", self.flow_id)
    ...
    def setup_arize_phoenix(self) -> bool:
        ...
        from earthmind.services.tracing.http_instrumentation import get_http_instrumentation_manager
