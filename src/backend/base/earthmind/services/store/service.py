...
from earthmind.services.store.exceptions import APIKeyError, FilterError, ForbiddenError
...
from earthmind.services.store.utils import (
...
def get_id_from_search_string(search_string: str) -> str | None:
    ...
    if "www.earthmind.store/store/" in search_string:
...
class StoreService(Service):
    """This is a service that integrates earthmind with the store which is a Directus instance.
