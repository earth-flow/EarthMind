...
from earthmind.exceptions.api import WorkflowResourceError, WorkflowServiceUnavailableError
from earthmind.services.base import Service
from earthmind.services.deps import get_queue_service
from earthmind.services.task.backends.anyio import AnyIOBackend
from earthmind.services.task.backends.celery import CeleryBackend

if TYPE_CHECKING:
    from lfx.services.settings.service import SettingsService

    from earthmind.services.task.backends.base import TaskBackend
...
class TaskService(Service):
    ...
    async def revoke_task(self, task_id: UUID | str) -> bool:
        ...
        try:
            ...
            if str(e) != "EARTHMIND_USER_CANCELLED":
                raise
            return True
        return True
