...
if TYPE_CHECKING:
    ...
    from earthmind.services.cache.service import AsyncBaseCacheService, CacheService
    from earthmind.services.chat.service import ChatService
    from earthmind.services.database.service import DatabaseService
    from earthmind.services.session.service import SessionService
    from earthmind.services.state.service import StateService
    from earthmind.services.store.service import StoreService
    from earthmind.services.task.service import TaskService
    from earthmind.services.tracing.service import TracingService
    from earthmind.services.variable.service import VariableService
...
from earthmind.services.job_queue.service import JobQueueService  # noqa: TC001
from earthmind.services.storage.service import StorageService  # noqa: TC001
from earthmind.services.telemetry.service import TelemetryService  # noqa: TC001
...
def get_service(service_type: ServiceType, default=None):
    ...
    if not service_manager.are_factories_registered():
        ...
        from earthmind.services.manager import ServiceManager
...
def get_telemetry_service() -> TelemetryService:
    ...
    """
    from earthmind.services.telemetry.factory import TelemetryServiceFactory
...
def get_tracing_service() -> TracingService:
    ...
    """
    from earthmind.services.tracing.factory import TracingServiceFactory
...
def get_state_service() -> StateService:
    ...
    """
    from earthmind.services.state.factory import StateServiceFactory
...
def get_storage_service() -> StorageService:
    ...
    """
    from earthmind.services.storage.factory import StorageServiceFactory
...
def get_variable_service() -> VariableService:
    ...
    """
    from earthmind.services.variable.factory import VariableServiceFactory
...
def get_db_service() -> DatabaseService:
    ...
    """
    from earthmind.services.database.factory import DatabaseServiceFactory
...
def get_shared_component_cache_service() -> CacheService:
    ...
    Returns:
        The cache service instance.
    """
    from earthmind.services.shared_component_cache.factory import SharedComponentCacheServiceFactory
...
def get_session_service() -> SessionService:
    ...
    """
    from earthmind.services.session.factory import SessionServiceFactory
...
def get_task_service() -> TaskService:
    ...
    """
    from earthmind.services.task.factory import TaskServiceFactory
...
def get_queue_service() -> JobQueueService:
    ...
    from earthmind.services.job_queue.factory import JobQueueServiceFactory
...
def get_auth_service() -> BaseAuthService:
    ...
    from earthmind.services.auth.factory import AuthServiceFactory
...
def get_job_service():
    ...
    """
    from earthmind.services.jobs.factory import JobServiceFactory

    return get_service(ServiceType.JOB_SERVICE, JobServiceFactory())


def get_flow_events_service():
    from earthmind.services.flow_events.factory import FlowEventsServiceFactory
...
def get_memory_base_service():
    ...
    from earthmind.services.memory_base.factory import MemoryBaseServiceFactory

    return get_service(ServiceType.MEMORY_BASE_SERVICE, MemoryBaseServiceFactory())


def get_telemetry_writer_service():
    """Return the TelemetryWriterService instance (always registered when earthmind is installed)."""
    from earthmind.services.telemetry_writer.factory import TelemetryWriterServiceFactory
