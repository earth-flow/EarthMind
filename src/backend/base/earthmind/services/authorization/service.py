"""EarthMind authorization service (OSS pass-through; plugins enforce RBAC)."""
...
class EarthMindAuthorizationService(BaseAuthorizationService):
    ...
    def __init__(self, settings_service: SettingsService) -> None:
        ...
        self.set_ready()
        logger.debug("EarthMind authorization service initialized")
        ...
        if authz_enabled and not self.SUPPORTS_CROSS_USER_FETCH:
            logger.warning(
                "EARTHMIND_AUTHZ_ENABLED=true but the OSS pass-through authorization service is "
                ...
                "Register an authorization plugin via lfx.toml or set EARTHMIND_AUTHZ_ENABLED=false "
