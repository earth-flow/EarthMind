"""Transaction service implementation for earthmind."""
...
from earthmind.services.database.models.transactions.crud import log_transaction as crud_log_transaction
