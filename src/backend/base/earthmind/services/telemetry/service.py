...
class TelemetryService(Service):
    ...
    def __init__(self, settings_service: SettingsService):
        ...
        self.common_telemetry_fields = {
            ...
            "platform": "desktop" if self._get_earthmind_desktop() else "python_package",
    ...
    def _get_earthmind_desktop(self) -> bool:
        # Coerce to bool, could be 1, 0, True, False, "1", "0", "True", "False"
        return str(os.getenv("EARTHMIND_DESKTOP", "False")).lower() in {"1", "true"}

    def _get_client_type(self) -> str:
        return "desktop" if self._get_earthmind_desktop() else "oss"

    async def _send_email_telemetry(self) -> None:
        """Send the telemetry event for the registered email address."""
        from earthmind.utils.registered_email_util import get_email_model
    ...
    def start(self) -> None:
        ...
        try:
            ...
            if self._get_earthmind_desktop():
