...
from earthmind.helpers.user import get_user_by_flow_id_or_endpoint_name
from earthmind.services.auth.constants import AUTO_LOGIN_ERROR, AUTO_LOGIN_WARNING
...
from earthmind.services.database.models.user.crud import (
    get_user_by_id,
...
class AuthService(BaseAuthService):
    """Default EarthMind authentication service (implements LFX BaseAuthService)."""
    ...
    async def _authenticate_with_token(self, token: str, db: AsyncSession) -> User:
        ...
        from earthmind.services.auth.utils import ACCESS_TOKEN_TYPE, get_jwt_verification_key
