...
from earthmind.services.deps import get_job_service, get_task_service, session_scope
from earthmind.services.jobs import DuplicateJobError
from earthmind.services.memory_base.kb_path_helpers import (
    hash_session_id,
    resolve_embedding,
    resolve_kb_username,
...
async def purge_session_data(
    *,
    ...
    from earthmind.services.database.models.memory_base.model import MessageIngestionRecord
