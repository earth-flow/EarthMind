...
from earthmind.services.adapters.deployment.watsonx_orchestrate.client import get_authenticator, get_provider_clients
from earthmind.services.adapters.deployment.watsonx_orchestrate.constants import (
    SUPPORTED_ADAPTER_DEPLOYMENT_TYPES,
    ErrorPrefix,
)
from earthmind.services.adapters.deployment.watsonx_orchestrate.core.config import (
    list_configs as list_adapter_configs,
)
from earthmind.services.adapters.deployment.watsonx_orchestrate.core.create import (
    apply_provider_create_plan_with_rollback,
    build_provider_create_plan,
    validate_provider_create_request_sections,
)
from earthmind.services.adapters.deployment.watsonx_orchestrate.core.execution import (
    create_agent_run,
    get_agent_run,
)
from earthmind.services.adapters.deployment.watsonx_orchestrate.core.models import (
    fetch_models_adapter,
)
from earthmind.services.adapters.deployment.watsonx_orchestrate.core.retry import (
    retry_update,
    rollback_created_resources,
)
from earthmind.services.adapters.deployment.watsonx_orchestrate.core.status import (
...
from earthmind.services.adapters.deployment.watsonx_orchestrate.core.tools import (
    ...
    extract_earthmind_connections_binding,
    upload_tool_artifact_bytes,
    verify_tools_by_ids,
)
from earthmind.services.adapters.deployment.watsonx_orchestrate.core.update import (
...
class WatsonxOrchestrateDeploymentService(BaseDeploymentService):
    ...
    async def update_snapshot(
        ...
        *,
        ...
        EarthMind flow name. This is intentional: the user may have set a
        ...
        * **Tool renamed in wxO console** — The new name is picked up
          ...
          EarthMind never stores the tool name locally.
        ...
        **Blast-radius boundary:** callers must verify that ``snapshot_id``
        is tracked by a EarthMind attachment record before calling this
        ...
        # been deployed with a custom name that differs from the EarthMind flow
