...
""")
    ...
    url_component.set(urls=["https://earthmind.org/", "https://docs.earthmind.org/"])
    ...
    text_input.set(
        input_value="Use the references above for style to write a new blog/tutorial about EarthMind and AI. "
