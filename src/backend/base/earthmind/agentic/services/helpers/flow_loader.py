...
from earthmind.agentic.services.flow_preparation import load_and_prepare_flow
from earthmind.agentic.services.flow_types import FLOWS_BASE_PATH
...
async def _load_graph_from_python(
    ...
    trace_token = None
    try:
        from earthmind.services.tracing.service import trace_context_var
