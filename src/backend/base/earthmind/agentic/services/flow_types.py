...
EARTHMIND_ASSISTANT_FLOW = "EarthMindAssistant.json"
...
OFF_TOPIC_REFUSAL_MESSAGE = (
    "I appreciate your interest, but I'm the EarthMind Assistant and can only help with "
    "EarthMind-related topics such as building components, creating flows, configuring "
    "deployments, and troubleshooting issues. Could you rephrase your question about EarthMind?"
)
...
FLOW_VERIFICATION_ENABLED_ENV = "EARTHMIND_ASSISTANT_VERIFY_FLOWS"
...
Respond with a complete, valid EarthMind component as a Python class extending Component, \
