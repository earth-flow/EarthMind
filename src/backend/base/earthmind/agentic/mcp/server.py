"""FastMCP server for EarthMind Agentic tools.
...
from earthmind.agentic.mcp.support import replace_none_and_null_with_empty_str
from earthmind.agentic.utils.component_search import (
...
from earthmind.agentic.utils.flow_component import (
...
from earthmind.agentic.utils.template_create import (
    create_flow_from_template_and_get_link,
)
from earthmind.agentic.utils.template_search import (
    get_all_tags,
    get_template_by_id,
    get_templates_count,
    list_templates,
