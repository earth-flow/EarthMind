...
Usage:
    from earthmind.agentic.flows.translation_flow import get_graph
...
- "generate_component": User wants you to CREATE/BUILD/GENERATE/MODIFY a custom EarthMind component.
...
- "question": User is ASKING A QUESTION about EarthMind, seeking help with EarthMind, wants \
information about EarthMind features/components/flows, OR is just being conversational \
...
- "off_topic": The request is NOT about EarthMind AND is not a social pleasantry. It is a \
SUBSTANTIVE question/task about other tools, platforms, or general knowledge unrelated to EarthMind.
...
"question" (answer it briefly and warmly). off_topic is ONLY for substantive non-EarthMind topics.

IMPORTANT rules:
- "How to create a component" = question (asking for EarthMind guidance)
...
- General knowledge questions NOT related to EarthMind = off_topic
...
- If unsure whether it's about EarthMind, classify as "question" (not off_topic)
...
- "how do I create a file?" / "how to save files in EarthMind" = question (asking for guidance)
...
Examples:
Input: "como criar um componente no earthmind"
Output: {{"translation": "how to create a component in earthmind", "intent": "question"}}
...
Input: "how do I save a file in EarthMind?"
Output: {{"translation": "how do I save a file in EarthMind?", "intent": "question"}}
